...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 27 7c 10 80 	movl   $0x80107c27,(%esp)
...
801012aa:	e8 01 32 00 00       	call   801044b0 <acquire>
...
8010130f:	e8 5c 32 00 00       	call   80104570 <release>
...
8010133a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010133d:	e8 2e 32 00 00       	call   80104570 <release>
      return ip;
...
80101496:	e8 d5 2e 00 00       	call   80104370 <initlock>
...
801014af:	e8 8c 2d 00 00       	call   80104240 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010165f:	e8 4c 2e 00 00       	call   801044b0 <acquire>
  ip->ref++;
80101664:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101668:	c7 04 24 00 0a 11 80 	movl   $0x80110a00,(%esp)
8010166f:	e8 fc 2e 00 00       	call   80104570 <release>
}
...
801016a2:	e8 d9 2b 00 00       	call   80104280 <acquiresleep>
  if(ip->valid == 0){
...
80101773:	e8 a8 2b 00 00       	call   80104320 <holdingsleep>
...
8010178e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010178f:	e9 4c 2b 00 00       	jmp    801042e0 <releasesleep>
    panic("iunlock");
...
801017c0:	e8 bb 2a 00 00       	call   80104280 <acquiresleep>
...
801017da:	e8 01 2b 00 00       	call   801042e0 <releasesleep>
  acquire(&icache.lock);
801017df:	c7 04 24 00 0a 11 80 	movl   $0x80110a00,(%esp)
801017e6:	e8 c5 2c 00 00       	call   801044b0 <acquire>
  ip->ref--;
...
801017ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101800:	e9 6b 2d 00 00       	jmp    80104570 <release>
80101805:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101808:	83 ec 0c             	sub    $0xc,%esp
8010180b:	68 00 0a 11 80       	push   $0x80110a00
80101810:	e8 9b 2c 00 00       	call   801044b0 <acquire>
    int r = ip->ref;
...
80101c89:	e8 22 28 00 00       	call   801044b0 <acquire>
  ip->ref++;
80101c8e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c92:	c7 04 24 00 0a 11 80 	movl   $0x80110a00,(%esp)
80101c99:	e8 d2 28 00 00       	call   80104570 <release>
...
80101ec8:	68 0e 7a 10 80       	push   $0x80107a0e
...
80102010:	e8 5b 23 00 00       	call   80104370 <initlock>
...
8010208e:	e8 1d 24 00 00       	call   801044b0 <acquire>
...
8010210f:	e8 5c 24 00 00       	call   80104570 <release>
...
8010212e:	e8 ed 21 00 00       	call   80104320 <holdingsleep>
...
80102168:	e8 43 23 00 00       	call   801044b0 <acquire>
...
801021d5:	c9                   	leave  
  release(&idelock);
801021d6:	e9 95 23 00 00       	jmp    80104570 <release>
801021db:	90                   	nop
...
8010237a:	c9                   	leave  
    release(&kmem.lock);
8010237b:	e9 f0 21 00 00       	jmp    80104570 <release>
    acquire(&kmem.lock);
80102380:	83 ec 0c             	sub    $0xc,%esp
80102383:	68 60 26 11 80       	push   $0x80112660
80102388:	e8 23 21 00 00       	call   801044b0 <acquire>
...
80102405:	e8 66 1f 00 00       	call   80104370 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024f3:	e8 b8 1f 00 00       	call   801044b0 <acquire>
  r = kmem.freelist;
...
80102521:	e8 4a 20 00 00       	call   80104570 <release>
  return (char*)r;
...
80102b14:	e8 57 18 00 00       	call   80104370 <initlock>
  readsb(dev, &sb);
80102b19:	58                   	pop    %eax
...
80102bab:	e8 00 19 00 00       	call   801044b0 <acquire>
...
80102bfc:	e8 6f 19 00 00       	call   80104570 <release>
      break;
    }
  }
}
...
80102c1e:	e8 8d 18 00 00       	call   801044b0 <acquire>
  log.outstanding -= 1;
...
80102c5c:	e8 0f 19 00 00       	call   80104570 <release>
}
...
80102cff:	e8 ac 17 00 00       	call   801044b0 <acquire>
    wakeup(&log);
...
80102d21:	e8 4a 18 00 00       	call   80104570 <release>
...
80102dae:	e8 fd 16 00 00       	call   801044b0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dfc:	c9                   	leave  
  release(&log.lock);
80102dfd:	e9 6e 17 00 00       	jmp    80104570 <release>
...
80103301:	e8 6a 10 00 00       	call   80104370 <initlock>
  (*f0)->type = FD_PIPE;
...
8010335f:	e8 4c 11 00 00       	call   801044b0 <acquire>
  if(writable){
...
801033a3:	5d                   	pop    %ebp
    release(&p->lock);
801033a4:	e9 c7 11 00 00       	jmp    80104570 <release>
...
801033d4:	e8 97 11 00 00       	call   80104570 <release>
    kfree((char*)p);
...
801033fd:	e8 ae 10 00 00       	call   801044b0 <acquire>
  for(i = 0; i < n; i++){
...
801034eb:	e8 80 10 00 00       	call   80104570 <release>
  return n;
...
80103510:	e8 9b 0f 00 00       	call   801044b0 <acquire>
...
8010357e:	e8 ed 0f 00 00       	call   80104570 <release>
      return -1;
...
801035df:	e8 8c 0f 00 00       	call   80104570 <release>
  return i;
...
80103604:	bb 34 2e 11 80       	mov    $0x80112e34,%ebx
{
80103609:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010360c:	68 00 2e 11 80       	push   $0x80112e00
80103611:	e8 9a 0e 00 00       	call   801044b0 <acquire>
...
80103623:	81 fb 34 4e 11 80    	cmp    $0x80114e34,%ebx
...
80103644:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103647:	68 00 2e 11 80       	push   $0x80112e00
  p->pid = nextpid++;
8010364c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103652:	e8 19 0f 00 00       	call   80104570 <release>
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 8f 59 10 80 	movl   $0x8010598f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103686:	e8 a5 10 00 00       	call   80104730 <memset>
...
801036a3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036a5:	68 00 2e 11 80       	push   $0x80112e00
801036aa:	e8 c1 0e 00 00       	call   80104570 <release>
}
...
801036d3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036d6:	68 00 2e 11 80       	push   $0x80112e00
801036db:	e8 90 0e 00 00       	call   80104570 <release>
...
8010372b:	68 00 2e 11 80       	push   $0x80112e00
80103730:	e8 3b 0c 00 00       	call   80104370 <initlock>
}
...
801037e4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037e7:	e8 f4 0b 00 00       	call   801043e0 <pushcli>
  c = mycpu();
801037ec:	e8 4f ff ff ff       	call   80103740 <mycpu>
  p = c->proc;
801037f1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037f7:	e8 24 0c 00 00       	call   80104420 <popcli>
}
...
80103823:	e8 38 37 00 00       	call   80106f60 <setupkvm>
...
80103841:	e8 fa 33 00 00       	call   80106c40 <inituvm>
...
80103856:	e8 d5 0e 00 00       	call   80104730 <memset>
...
801038af:	68 85 77 10 80       	push   $0x80107785
801038b4:	50                   	push   %eax
801038b5:	e8 56 10 00 00       	call   80104910 <safestrcpy>
  p->cwd = namei("/");
801038ba:	c7 04 24 8e 77 10 80 	movl   $0x8010778e,(%esp)
801038c1:	e8 1a e6 ff ff       	call   80101ee0 <namei>
801038c6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801038c9:	c7 04 24 00 2e 11 80 	movl   $0x80112e00,(%esp)
801038d0:	e8 db 0b 00 00       	call   801044b0 <acquire>
  p->state = RUNNABLE;
801038d5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801038dc:	c7 04 24 00 2e 11 80 	movl   $0x80112e00,(%esp)
801038e3:	e8 88 0c 00 00       	call   80104570 <release>
}
...
801038f3:	68 6c 77 10 80       	push   $0x8010776c
...
80103905:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103908:	e8 d3 0a 00 00       	call   801043e0 <pushcli>
  c = mycpu();
8010390d:	e8 2e fe ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103912:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103918:	e8 03 0b 00 00       	call   80104420 <popcli>
  if(n > 0){
...
8010392c:	e8 ff 31 00 00       	call   80106b30 <switchuvm>
  return 0;
...
8010394a:	e8 31 34 00 00       	call   80106d80 <allocuvm>
...
8010396a:	e8 41 35 00 00       	call   80106eb0 <deallocuvm>
...
80103986:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103989:	e8 52 0a 00 00       	call   801043e0 <pushcli>
  c = mycpu();
8010398e:	e8 ad fd ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103993:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103999:	e8 82 0a 00 00       	call   80104420 <popcli>
  if((np = allocproc()) == 0){
...
801039b8:	e8 73 36 00 00       	call   80107030 <copyuvm>
...
80103a31:	e8 da 0e 00 00       	call   80104910 <safestrcpy>
  pid = np->pid;
80103a36:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a39:	c7 04 24 00 2e 11 80 	movl   $0x80112e00,(%esp)
80103a40:	e8 6b 0a 00 00       	call   801044b0 <acquire>
  np->state = RUNNABLE;
80103a45:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a4c:	c7 04 24 00 2e 11 80 	movl   $0x80112e00,(%esp)
...
80103ac1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ac4:	bb 34 2e 11 80       	mov    $0x80112e34,%ebx
    acquire(&ptable.lock);
80103ac9:	68 00 2e 11 80       	push   $0x80112e00
80103ace:	e8 dd 09 00 00       	call   801044b0 <acquire>
...
80103af0:	e8 3b 30 00 00       	call   80106b30 <switchuvm>
...
80103afb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b02:	e8 64 0e 00 00       	call   8010496b <swtch>
      switchkvm();
80103b07:	e8 04 30 00 00       	call   80106b10 <switchkvm>
      c->proc = 0;
...
80103b1c:	81 fb 34 4e 11 80    	cmp    $0x80114e34,%ebx
80103b22:	72 bc                	jb     80103ae0 <scheduler+0x40>
    release(&ptable.lock);
80103b24:	83 ec 0c             	sub    $0xc,%esp
80103b27:	68 00 2e 11 80       	push   $0x80112e00
80103b2c:	e8 3f 0a 00 00       	call   80104570 <release>
    sti();
...
80103b44:	53                   	push   %ebx
  pushcli();
80103b45:	e8 96 08 00 00       	call   801043e0 <pushcli>
  c = mycpu();
80103b4a:	e8 f1 fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103b4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b55:	e8 c6 08 00 00       	call   80104420 <popcli>
  if(!holding(&ptable.lock))
80103b5a:	83 ec 0c             	sub    $0xc,%esp
80103b5d:	68 00 2e 11 80       	push   $0x80112e00
80103b62:	e8 19 09 00 00       	call   80104480 <holding>
...
80103ba3:	e8 c3 0d 00 00       	call   8010496b <swtch>
  mycpu()->intena = intena;
...
80103c06:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c09:	e8 d2 07 00 00       	call   801043e0 <pushcli>
  c = mycpu();
80103c0e:	e8 2d fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103c13:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c19:	e8 02 08 00 00       	call   80104420 <popcli>
  if(curproc == initproc)
80103c1e:	39 35 c0 a5 10 80    	cmp    %esi,0x8010a5c0
...
80103c64:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103c6b:	c7 04 24 00 2e 11 80 	movl   $0x80112e00,(%esp)
80103c72:	e8 39 08 00 00       	call   801044b0 <acquire>
...
80103ca7:	3d 34 4e 11 80       	cmp    $0x80114e34,%eax
80103cac:	72 e4                	jb     80103c92 <exit+0x92>
      p->parent = initproc;
80103cae:	8b 0d c0 a5 10 80    	mov    0x8010a5c0,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb4:	ba 34 2e 11 80       	mov    $0x80112e34,%edx
80103cb9:	eb 10                	jmp    80103ccb <exit+0xcb>
80103cbb:	90                   	nop
80103cbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103cc0:	83 ea 80             	sub    $0xffffff80,%edx
80103cc3:	81 fa 34 4e 11 80    	cmp    $0x80114e34,%edx
...
80103cd7:	75 e7                	jne    80103cc0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cd9:	b8 34 2e 11 80       	mov    $0x80112e34,%eax
80103cde:	eb 0a                	jmp    80103cea <exit+0xea>
80103ce0:	83 e8 80             	sub    $0xffffff80,%eax
80103ce3:	3d 34 4e 11 80       	cmp    $0x80114e34,%eax
...
80103d0d:	68 dd 77 10 80       	push   $0x801077dd
80103d12:	e8 79 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d17:	83 ec 0c             	sub    $0xc,%esp
80103d1a:	68 d0 77 10 80       	push   $0x801077d0
...
80103d37:	68 00 2e 11 80       	push   $0x80112e00
80103d3c:	e8 6f 07 00 00       	call   801044b0 <acquire>
  pushcli();
80103d41:	e8 9a 06 00 00       	call   801043e0 <pushcli>
  c = mycpu();
80103d46:	e8 f5 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d51:	e8 ca 06 00 00       	call   80104420 <popcli>
  myproc()->state = RUNNABLE;
80103d56:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103d5d:	e8 de fd ff ff       	call   80103b40 <sched>
  release(&ptable.lock);
80103d62:	c7 04 24 00 2e 11 80 	movl   $0x80112e00,(%esp)
80103d69:	e8 02 08 00 00       	call   80104570 <release>
}
...
80103d8c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d8f:	e8 4c 06 00 00       	call   801043e0 <pushcli>
  c = mycpu();
80103d94:	e8 a7 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d99:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d9f:	e8 7c 06 00 00       	call   80104420 <popcli>
  if(p == 0)
...
80103db0:	81 fe 00 2e 11 80    	cmp    $0x80112e00,%esi
80103db6:	74 50                	je     80103e08 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103db8:	83 ec 0c             	sub    $0xc,%esp
80103dbb:	68 00 2e 11 80       	push   $0x80112e00
80103dc0:	e8 eb 06 00 00       	call   801044b0 <acquire>
    release(lk);
80103dc5:	89 34 24             	mov    %esi,(%esp)
80103dc8:	e8 a3 07 00 00       	call   80104570 <release>
  p->chan = chan;
...
80103ddc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103de3:	c7 04 24 00 2e 11 80 	movl   $0x80112e00,(%esp)
80103dea:	e8 81 07 00 00       	call   80104570 <release>
    acquire(lk);
...
80103dfb:	5d                   	pop    %ebp
    acquire(lk);
80103dfc:	e9 af 06 00 00       	jmp    801044b0 <acquire>
...
80103e29:	68 ef 77 10 80       	push   $0x801077ef
80103e2e:	e8 5d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e33:	83 ec 0c             	sub    $0xc,%esp
80103e36:	68 e9 77 10 80       	push   $0x801077e9
...
80103e91:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e96:	81 fb 34 4e 11 80    	cmp    $0x80114e34,%ebx
...
80103eac:	68 00 2e 11 80       	push   $0x80112e00
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 02 30 00 00       	call   80106ee0 <freevm>
        release(&ptable.lock);
80103ede:	c7 04 24 00 2e 11 80 	movl   $0x80112e00,(%esp)
        p->pid = 0;
...
80103efe:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f05:	e8 66 06 00 00       	call   80104570 <release>
        return pid;
...
80103f19:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f1e:	68 00 2e 11 80       	push   $0x80112e00
80103f23:	e8 48 06 00 00       	call   80104570 <release>
      return -1;
...
80103f37:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103f3a:	68 00 2e 11 80       	push   $0x80112e00
80103f3f:	e8 6c 05 00 00       	call   801044b0 <acquire>
80103f44:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f47:	b8 34 2e 11 80       	mov    $0x80112e34,%eax
80103f4c:	eb 0c                	jmp    80103f5a <wakeup+0x2a>
80103f4e:	66 90                	xchg   %ax,%ax
80103f50:	83 e8 80             	sub    $0xffffff80,%eax
80103f53:	3d 34 4e 11 80       	cmp    $0x80114e34,%eax
...
80103f6f:	3d 34 4e 11 80       	cmp    $0x80114e34,%eax
80103f74:	72 e4                	jb     80103f5a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80103f76:	c7 45 08 00 2e 11 80 	movl   $0x80112e00,0x8(%ebp)
}
80103f7d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103f80:	c9                   	leave  
  release(&ptable.lock);
80103f81:	e9 ea 05 00 00       	jmp    80104570 <release>
...
80103f97:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
80103f9a:	68 00 2e 11 80       	push   $0x80112e00
80103f9f:	e8 0c 05 00 00       	call   801044b0 <acquire>
80103fa4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fa7:	b8 34 2e 11 80       	mov    $0x80112e34,%eax
80103fac:	eb 0c                	jmp    80103fba <kill+0x2a>
80103fae:	66 90                	xchg   %ax,%ax
80103fb0:	83 e8 80             	sub    $0xffffff80,%eax
80103fb3:	3d 34 4e 11 80       	cmp    $0x80114e34,%eax
...
80103fd6:	68 00 2e 11 80       	push   $0x80112e00
80103fdb:	e8 90 05 00 00       	call   80104570 <release>
      return 0;
...
80103ff3:	68 00 2e 11 80       	push   $0x80112e00
80103ff8:	e8 73 05 00 00       	call   80104570 <release>
  return -1;
...
80104016:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104019:	bb 34 2e 11 80       	mov    $0x80112e34,%ebx
{
...
8010404e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104051:	ba 00 78 10 80       	mov    $0x80107800,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104056:	77 11                	ja     80104069 <procdump+0x59>
80104058:	8b 14 85 9c 78 10 80 	mov    -0x7fef8764(,%eax,4),%edx
      state = "???";
8010405f:	b8 00 78 10 80       	mov    $0x80107800,%eax
...
80104071:	68 04 78 10 80       	push   $0x80107804
...
801040ad:	68 41 72 10 80       	push   $0x80107241
...
801040d6:	68 0d 78 10 80       	push   $0x8010780d
801040db:	68 c0 2d 11 80       	push   $0x80112dc0
801040e0:	e8 db 04 00 00       	call   801045c0 <initlockticket>
  return 0;
}
...
801040f3:	83 ec 14             	sub    $0x14,%esp
  acquireticket(&lk);
801040f6:	68 c0 2d 11 80       	push   $0x80112dc0
801040fb:	e8 30 05 00 00       	call   80104630 <acquireticket>
  cprintf("ticket number is : %d and index is : %d \n",lk.ticket,lk.index);
80104100:	83 c4 0c             	add    $0xc,%esp
80104103:	ff 35 c4 2d 11 80    	pushl  0x80112dc4
80104109:	ff 35 c0 2d 11 80    	pushl  0x80112dc0
8010410f:	68 70 78 10 80       	push   $0x80107870
80104114:	e8 47 c5 ff ff       	call   80100660 <cprintf>
  releaseticket(&lk);
80104119:	c7 04 24 c0 2d 11 80 	movl   $0x80112dc0,(%esp)
80104120:	e8 bb 05 00 00       	call   801046e0 <releaseticket>
  return 0;
}
80104125:	31 c0                	xor    %eax,%eax
80104127:	c9                   	leave  
80104128:	c3                   	ret    
...
80104136:	68 18 78 10 80       	push   $0x80107818
8010413b:	68 80 2d 11 80       	push   $0x80112d80
80104140:	e8 7b 04 00 00       	call   801045c0 <initlockticket>
  initlockticket(&write,name2);
80104145:	58                   	pop    %eax
80104146:	5a                   	pop    %edx
80104147:	68 20 72 10 80       	push   $0x80107220
8010414c:	68 40 2d 11 80       	push   $0x80112d40
80104151:	e8 6a 04 00 00       	call   801045c0 <initlockticket>
  return 0;
}
...
8010416b:	75 73                	jne    801041e0 <rwtest+0x80>
    acquireticket(&mutex);
8010416d:	83 ec 0c             	sub    $0xc,%esp
80104170:	68 80 2d 11 80       	push   $0x80112d80
80104175:	e8 b6 04 00 00       	call   80104630 <acquireticket>
    readerscount++;
8010417a:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
    if(readerscount==1)
...
80104185:	83 f8 01             	cmp    $0x1,%eax
    readerscount++;
80104188:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
    if(readerscount==1)
8010418d:	0f 84 95 00 00 00    	je     80104228 <rwtest+0xc8>
    {
      acquireticket(&write);
    }
...
80104196:	68 80 2d 11 80       	push   $0x80112d80
8010419b:	e8 40 05 00 00       	call   801046e0 <releaseticket>
    //read
    acquireticket(&mutex);
801041a0:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
801041a7:	e8 84 04 00 00       	call   80104630 <acquireticket>
    readerscount--;
801041ac:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
    if(readerscount==0){
801041b1:	83 c4 10             	add    $0x10,%esp
    readerscount--;
801041b4:	83 e8 01             	sub    $0x1,%eax
    if(readerscount==0){
801041b7:	85 c0                	test   %eax,%eax
    readerscount--;
801041b9:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
    if(readerscount==0){
801041be:	74 50                	je     80104210 <rwtest+0xb0>
      releaseticket(&write);
    }
    releaseticket(&mutex);
801041c0:	83 ec 0c             	sub    $0xc,%esp
801041c3:	68 80 2d 11 80       	push   $0x80112d80
801041c8:	e8 13 05 00 00       	call   801046e0 <releaseticket>
      acquireticket(&write);
      sharedcounter++;
      releaseticket(&write);
  }
  return sharedcounter;
801041cd:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
...
801041e3:	68 40 2d 11 80       	push   $0x80112d40
801041e8:	e8 43 04 00 00       	call   80104630 <acquireticket>
      releaseticket(&write);
801041ed:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
      sharedcounter++;
801041f4:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
      releaseticket(&write);
801041fb:	e8 e0 04 00 00       	call   801046e0 <releaseticket>
80104200:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
      releaseticket(&write);
...
80104213:	68 40 2d 11 80       	push   $0x80112d40
80104218:	e8 c3 04 00 00       	call   801046e0 <releaseticket>
8010421d:	83 c4 10             	add    $0x10,%esp
80104220:	eb 9e                	jmp    801041c0 <rwtest+0x60>
80104222:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquireticket(&write);
80104228:	83 ec 0c             	sub    $0xc,%esp
8010422b:	68 40 2d 11 80       	push   $0x80112d40
80104230:	e8 fb 03 00 00       	call   80104630 <acquireticket>
80104235:	83 c4 10             	add    $0x10,%esp
80104238:	e9 56 ff ff ff       	jmp    80104193 <rwtest+0x33>
...
8010424a:	68 b4 78 10 80       	push   $0x801078b4
...
801042b3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801042b9:	e8 22 f5 ff ff       	call   801037e0 <myproc>
...
80104304:	e8 27 fc ff ff       	call   80103f30 <wakeup>
  release(&lk->lk);
...
80104343:	e8 98 f4 ff ff       	call   801037e0 <myproc>
...
801043ff:	e8 3c f3 ff ff       	call   80103740 <mycpu>
80104404:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010440a:	e8 31 f3 ff ff       	call   80103740 <mycpu>
...
8010444c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104450:	e8 eb f2 ff ff       	call   80103740 <mycpu>
...
80104465:	68 bf 78 10 80       	push   $0x801078bf
8010446a:	e8 21 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010446f:	83 ec 0c             	sub    $0xc,%esp
80104472:	68 d6 78 10 80       	push   $0x801078d6
...
80104498:	e8 a3 f2 ff ff       	call   80103740 <mycpu>
...
801044f4:	e8 47 f2 ff ff       	call   80103740 <mycpu>
...
80104557:	68 dd 78 10 80       	push   $0x801078dd
...
801045ac:	68 e5 78 10 80       	push   $0x801078e5
...
801045c9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->name = name;
801045cf:	89 50 08             	mov    %edx,0x8(%eax)
  lk->index = 0;
801045d2:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  lk->cpu = 0;
801045d9:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
}
801045e0:	5d                   	pop    %ebp
801045e1:	c3                   	ret    
...
801045f8:	31 f6                	xor    %esi,%esi
  int r;
  pushcli();
801045fa:	e8 e1 fd ff ff       	call   801043e0 <pushcli>
  r = lock->index>=lock->ticket && lock->cpu == mycpu();
801045ff:	8b 03                	mov    (%ebx),%eax
80104601:	39 43 04             	cmp    %eax,0x4(%ebx)
80104604:	7c 12                	jl     80104618 <holdingticket+0x28>
80104606:	8b 5b 0c             	mov    0xc(%ebx),%ebx
80104609:	e8 32 f1 ff ff       	call   80103740 <mycpu>
8010460e:	39 c3                	cmp    %eax,%ebx
80104610:	0f 94 c0             	sete   %al
80104613:	0f b6 c0             	movzbl %al,%eax
80104616:	89 c6                	mov    %eax,%esi
  popcli();
80104618:	e8 03 fe ff ff       	call   80104420 <popcli>
  return r;
}
8010461d:	89 f0                	mov    %esi,%eax
8010461f:	5b                   	pop    %ebx
80104620:	5e                   	pop    %esi
80104621:	5d                   	pop    %ebp
80104622:	c3                   	ret    
...
80104636:	83 ec 0c             	sub    $0xc,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80104639:	e8 a2 fd ff ff       	call   801043e0 <pushcli>
  if(holdingticket(lk))
8010463e:	83 ec 0c             	sub    $0xc,%esp
80104641:	ff 75 08             	pushl  0x8(%ebp)
80104644:	e8 a7 ff ff ff       	call   801045f0 <holdingticket>
80104649:	83 c4 10             	add    $0x10,%esp
8010464c:	85 c0                	test   %eax,%eax
8010464e:	75 7d                	jne    801046cd <acquireticket+0x9d>
  myproc()->ticket=fetch_and_add(&lk->index,1);
80104650:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104653:	e8 88 f1 ff ff       	call   801037e0 <myproc>
}
...
80104658:	ba 01 00 00 00       	mov    $0x1,%edx
8010465d:	f0 0f c1 53 04       	lock xadd %edx,0x4(%ebx)
80104662:	89 50 7c             	mov    %edx,0x7c(%eax)
...
80104668:	8b 78 08             	mov    0x8(%eax),%edi
8010466b:	8b 30                	mov    (%eax),%esi
8010466d:	e8 6e f1 ff ff       	call   801037e0 <myproc>
80104672:	8b 58 7c             	mov    0x7c(%eax),%ebx
80104675:	e8 66 f1 ff ff       	call   801037e0 <myproc>
8010467a:	83 ec 0c             	sub    $0xc,%esp
8010467d:	57                   	push   %edi
8010467e:	56                   	push   %esi
8010467f:	53                   	push   %ebx
80104680:	ff 70 10             	pushl  0x10(%eax)
80104683:	68 0c 79 10 80       	push   $0x8010790c
80104688:	e8 d3 bf ff ff       	call   80100660 <cprintf>
  while(myproc()->ticket!=lk->ticket);
8010468d:	83 c4 20             	add    $0x20,%esp
80104690:	e8 4b f1 ff ff       	call   801037e0 <myproc>
80104695:	8b 55 08             	mov    0x8(%ebp),%edx
80104698:	8b 0a                	mov    (%edx),%ecx
8010469a:	39 48 7c             	cmp    %ecx,0x7c(%eax)
8010469d:	75 f1                	jne    80104690 <acquireticket+0x60>
  __sync_synchronize();
8010469f:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
801046a4:	8b 5d 08             	mov    0x8(%ebp),%ebx
801046a7:	e8 94 f0 ff ff       	call   80103740 <mycpu>
  getcallerpcs(&lk, lk->pcs);
...
801046b5:	83 c0 10             	add    $0x10,%eax
801046b8:	50                   	push   %eax
801046b9:	8d 45 08             	lea    0x8(%ebp),%eax
801046bc:	50                   	push   %eax
801046bd:	e8 ce fc ff ff       	call   80104390 <getcallerpcs>
}
...
801046eb:	e8 00 ff ff ff       	call   801045f0 <holdingticket>
801046f0:	83 c4 10             	add    $0x10,%esp
801046f3:	85 c0                	test   %eax,%eax
801046f5:	74 25                	je     8010471c <releaseticket+0x3c>
  lk->pcs[0] = 0;
...
8010470f:	f0 0f c1 03          	lock xadd %eax,(%ebx)
}
80104713:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104716:	c9                   	leave  
  popcli();
80104717:	e9 04 fd ff ff       	jmp    80104420 <popcli>
    panic("releaseticket");
8010471c:	83 ec 0c             	sub    $0xc,%esp
8010471f:	68 fb 78 10 80       	push   $0x801078fb
80104724:	e8 67 bc ff ff       	call   80100390 <panic>
...
801049c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801049ca:	e8 11 ee ff ff       	call   801037e0 <myproc>
...
80104a35:	e8 a6 ed ff ff       	call   801037e0 <myproc>
...
80104a43:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a46:	e8 95 ed ff ff       	call   801037e0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104b24:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b27:	e8 b4 ec ff ff       	call   801037e0 <myproc>
...
80104b3c:	8b 14 85 80 79 10 80 	mov    -0x7fef8680(,%eax,4),%edx
...
80104b60:	68 48 79 10 80       	push   $0x80107948
...
80104cb4:	68 04 7a 10 80       	push   $0x80107a04
...
80104ccc:	68 03 7a 10 80       	push   $0x80107a03
...
80104ce5:	68 f7 79 10 80       	push   $0x801079f7
...
80104cfa:	68 06 7a 10 80       	push   $0x80107a06
80104cff:	e8 8c b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104d04:	83 ec 0c             	sub    $0xc,%esp
80104d07:	68 e8 79 10 80       	push   $0x801079e8
...
80104d44:	e8 97 ea ff ff       	call   801037e0 <myproc>
...
80104d89:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104d8b:	e8 50 ea ff ff       	call   801037e0 <myproc>
...
80104ed3:	78 2b                	js     80104f00 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104ed5:	e8 06 e9 ff ff       	call   801037e0 <myproc>
...
801050f9:	58                   	pop    %eax
801050fa:	5a                   	pop    %edx
801050fb:	68 04 7a 10 80       	push   $0x80107a04
...
80105114:	68 03 7a 10 80       	push   $0x80107a03
...
8010530f:	0f 84 a6 00 00 00    	je     801053bb <sys_open+0x12b>
  struct proc *curproc = myproc();
80105315:	e8 c6 e4 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056bf:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056c1:	e8 1a e1 ff ff       	call   801037e0 <myproc>
...
801056e7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801056ea:	e8 f1 e0 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105721:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105728:	e8 b3 e0 ff ff       	call   801037e0 <myproc>
...
80105763:	5d                   	pop    %ebp
  return fork();
80105764:	e9 17 e2 ff ff       	jmp    80103980 <fork>
...
80105773:	83 ec 08             	sub    $0x8,%esp
  exit();
80105776:	e8 85 e4 ff ff       	call   80103c00 <exit>
...
80105783:	5d                   	pop    %ebp
  return wait();
80105784:	e9 b7 e6 ff ff       	jmp    80103e40 <wait>
...
801057ae:	e8 dd e7 ff ff       	call   80103f90 <kill>
...
801057d3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801057d6:	e8 05 e0 ff ff       	call   801037e0 <myproc>
...
80105806:	e8 f5 e0 ff ff       	call   80103900 <growproc>
...
80105850:	68 40 4e 11 80       	push   $0x80114e40
80105855:	e8 56 ec ff ff       	call   801044b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010585a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010585d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105860:	8b 1d 80 56 11 80    	mov    0x80115680,%ebx
  while(ticks - ticks0 < n){
...
80105873:	68 40 4e 11 80       	push   $0x80114e40
80105878:	68 80 56 11 80       	push   $0x80115680
8010587d:	e8 fe e4 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
80105882:	a1 80 56 11 80       	mov    0x80115680,%eax
...
801058a0:	68 40 4e 11 80       	push   $0x80114e40
801058a5:	e8 c6 ec ff ff       	call   80104570 <release>
      return -1;
...
801058c3:	68 40 4e 11 80       	push   $0x80114e40
801058c8:	e8 a3 ec ff ff       	call   80104570 <release>
  return 0;
...
801058e4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058e7:	68 40 4e 11 80       	push   $0x80114e40
801058ec:	e8 bf eb ff ff       	call   801044b0 <acquire>
  xticks = ticks;
801058f1:	8b 1d 80 56 11 80    	mov    0x80115680,%ebx
  release(&tickslock);
801058f7:	c7 04 24 40 4e 11 80 	movl   $0x80114e40,(%esp)
801058fe:	e8 6d ec ff ff       	call   80104570 <release>
  return xticks;
}
...
80105913:	5d                   	pop    %ebp
  return ticketlockInit();
80105914:	e9 b7 e7 ff ff       	jmp    801040d0 <ticketlockInit>
80105919:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105920 <sys_ticketlockTest>:
...
80105923:	5d                   	pop    %ebp
  return ticketlockTest();
80105924:	e9 c7 e7 ff ff       	jmp    801040f0 <ticketlockTest>
...
80105933:	5d                   	pop    %ebp
  return rwinit();
80105934:	e9 f7 e7 ff ff       	jmp    80104130 <rwinit>
...
80105956:	78 18                	js     80105970 <sys_rwtest+0x30>
    return -1;
  }
  return rwtest(type);
80105958:	83 ec 0c             	sub    $0xc,%esp
8010595b:	ff 75 f4             	pushl  -0xc(%ebp)
8010595e:	e8 fd e7 ff ff       	call   80104160 <rwtest>
...
801059b7:	c7 04 c5 82 4e 11 80 	movl   $0x8e000008,-0x7feeb17e(,%eax,8)
801059be:	08 00 00 8e 
801059c2:	66 89 14 c5 80 4e 11 	mov    %dx,-0x7feeb180(,%eax,8)
801059c9:	80 
801059ca:	c1 ea 10             	shr    $0x10,%edx
801059cd:	66 89 14 c5 86 4e 11 	mov    %dx,-0x7feeb17a(,%eax,8)
801059d4:	80 
  for(i = 0; i < 256; i++)
...
801059e4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059e7:	c7 05 82 50 11 80 08 	movl   $0xef000008,0x80115082
801059ee:	00 00 ef 
  initlock(&tickslock, "time");
801059f1:	68 49 7a 10 80       	push   $0x80107a49
801059f6:	68 40 4e 11 80       	push   $0x80114e40
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059fb:	66 a3 80 50 11 80    	mov    %ax,0x80115080
80105a01:	c1 e8 10             	shr    $0x10,%eax
80105a04:	66 a3 86 50 11 80    	mov    %ax,0x80115086
  initlock(&tickslock, "time");
80105a0a:	e8 61 e9 ff ff       	call   80104370 <initlock>
}
...
80105a2b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a2f:	b8 80 4e 11 80       	mov    $0x80114e80,%eax
...
80105a70:	ff 24 85 f0 7a 10 80 	jmp    *-0x7fef8510(,%eax,4)
...
80105a80:	e8 5b dd ff ff       	call   801037e0 <myproc>
...
80105ab1:	e8 2a dd ff ff       	call   801037e0 <myproc>
80105ab6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105ab9:	e8 22 dd ff ff       	call   801037e0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105ad5:	68 ac 7a 10 80       	push   $0x80107aac
...
80105aee:	e8 ed dc ff ff       	call   801037e0 <myproc>
80105af3:	85 c0                	test   %eax,%eax
80105af5:	74 1d                	je     80105b14 <trap+0xc4>
80105af7:	e8 e4 dc ff ff       	call   801037e0 <myproc>
...
80105b14:	e8 c7 dc ff ff       	call   801037e0 <myproc>
80105b19:	85 c0                	test   %eax,%eax
80105b1b:	74 0b                	je     80105b28 <trap+0xd8>
80105b1d:	e8 be dc ff ff       	call   801037e0 <myproc>
...
80105b31:	e8 aa dc ff ff       	call   801037e0 <myproc>
...
80105b52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105b58:	e8 83 dc ff ff       	call   801037e0 <myproc>
...
80105b70:	e8 ab ef ff ff       	call   80104b20 <syscall>
    if(myproc()->killed)
80105b75:	e8 66 dc ff ff       	call   801037e0 <myproc>
...
80105bcd:	e8 7e cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bd2:	e8 09 dc ff ff       	call   801037e0 <myproc>
...
80105c0f:	e8 ac db ff ff       	call   801037c0 <cpuid>
80105c14:	56                   	push   %esi
80105c15:	53                   	push   %ebx
80105c16:	50                   	push   %eax
80105c17:	68 54 7a 10 80       	push   $0x80107a54
...
80105c26:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c29:	e8 b2 db ff ff       	call   801037e0 <myproc>
...
80105c4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105c50:	e8 ab df ff ff       	call   80103c00 <exit>
...
80105c73:	68 40 4e 11 80       	push   $0x80114e40
80105c78:	e8 33 e8 ff ff       	call   801044b0 <acquire>
      wakeup(&ticks);
80105c7d:	c7 04 24 80 56 11 80 	movl   $0x80115680,(%esp)
      ticks++;
80105c84:	83 05 80 56 11 80 01 	addl   $0x1,0x80115680
      wakeup(&ticks);
80105c8b:	e8 a0 e2 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
80105c90:	c7 04 24 40 4e 11 80 	movl   $0x80114e40,(%esp)
80105c97:	e8 d4 e8 ff ff       	call   80104570 <release>
80105c9c:	83 c4 10             	add    $0x10,%esp
80105c9f:	e9 09 ff ff ff       	jmp    80105bad <trap+0x15d>
80105ca4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105ca7:	e8 14 db ff ff       	call   801037c0 <cpuid>
...
80105cb5:	68 78 7a 10 80       	push   $0x80107a78
80105cba:	e8 a1 a9 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105cbf:	83 c4 14             	add    $0x14,%esp
80105cc2:	68 4e 7a 10 80       	push   $0x80107a4e
...
80105dbc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105dbf:	bb 70 7b 10 80       	mov    $0x80107b70,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105e57:	6a 00                	push   $0x0
  jmp alltraps
80105e59:	e9 19 fb ff ff       	jmp    80105977 <alltraps>
...
80105e60:	6a 01                	push   $0x1
  jmp alltraps
80105e62:	e9 10 fb ff ff       	jmp    80105977 <alltraps>
...
80105e69:	6a 02                	push   $0x2
  jmp alltraps
80105e6b:	e9 07 fb ff ff       	jmp    80105977 <alltraps>
...
80105eb4:	6a 0b                	push   $0xb
  jmp alltraps
80105eb6:	e9 bc fa ff ff       	jmp    80105977 <alltraps>
...
80105ec9:	6a 0e                	push   $0xe
  jmp alltraps
80105ecb:	e9 a7 fa ff ff       	jmp    80105977 <alltraps>
...
80105edb:	6a 10                	push   $0x10
  jmp alltraps
80105edd:	e9 95 fa ff ff       	jmp    80105977 <alltraps>
...
80105ef4:	6a 13                	push   $0x13
  jmp alltraps
80105ef6:	e9 7c fa ff ff       	jmp    80105977 <alltraps>
...
80105efd:	6a 14                	push   $0x14
  jmp alltraps
80105eff:	e9 73 fa ff ff       	jmp    80105977 <alltraps>
...
80105f06:	6a 15                	push   $0x15
  jmp alltraps
80105f08:	e9 6a fa ff ff       	jmp    80105977 <alltraps>
...
80105f0f:	6a 16                	push   $0x16
  jmp alltraps
80105f11:	e9 61 fa ff ff       	jmp    80105977 <alltraps>
...
80105f18:	6a 17                	push   $0x17
  jmp alltraps
80105f1a:	e9 58 fa ff ff       	jmp    80105977 <alltraps>
...
80105f21:	6a 18                	push   $0x18
  jmp alltraps
80105f23:	e9 4f fa ff ff       	jmp    80105977 <alltraps>
...
80105f2a:	6a 19                	push   $0x19
  jmp alltraps
80105f2c:	e9 46 fa ff ff       	jmp    80105977 <alltraps>
...
80105f33:	6a 1a                	push   $0x1a
  jmp alltraps
80105f35:	e9 3d fa ff ff       	jmp    80105977 <alltraps>
...
80105f3c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f3e:	e9 34 fa ff ff       	jmp    80105977 <alltraps>
...
80105f45:	6a 1c                	push   $0x1c
  jmp alltraps
80105f47:	e9 2b fa ff ff       	jmp    80105977 <alltraps>
...
80105f4e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f50:	e9 22 fa ff ff       	jmp    80105977 <alltraps>
...
80105f57:	6a 1e                	push   $0x1e
  jmp alltraps
80105f59:	e9 19 fa ff ff       	jmp    80105977 <alltraps>
...
80105f60:	6a 1f                	push   $0x1f
  jmp alltraps
80105f62:	e9 10 fa ff ff       	jmp    80105977 <alltraps>
...
80105f69:	6a 20                	push   $0x20
  jmp alltraps
80105f6b:	e9 07 fa ff ff       	jmp    80105977 <alltraps>
...
80105f72:	6a 21                	push   $0x21
  jmp alltraps
80105f74:	e9 fe f9 ff ff       	jmp    80105977 <alltraps>
...
80105f7b:	6a 22                	push   $0x22
  jmp alltraps
80105f7d:	e9 f5 f9 ff ff       	jmp    80105977 <alltraps>
...
80105f84:	6a 23                	push   $0x23
  jmp alltraps
80105f86:	e9 ec f9 ff ff       	jmp    80105977 <alltraps>
...
80105f8d:	6a 24                	push   $0x24
  jmp alltraps
80105f8f:	e9 e3 f9 ff ff       	jmp    80105977 <alltraps>
...
80105f96:	6a 25                	push   $0x25
  jmp alltraps
80105f98:	e9 da f9 ff ff       	jmp    80105977 <alltraps>
...
80105f9f:	6a 26                	push   $0x26
  jmp alltraps
80105fa1:	e9 d1 f9 ff ff       	jmp    80105977 <alltraps>
...
80105fa8:	6a 27                	push   $0x27
  jmp alltraps
80105faa:	e9 c8 f9 ff ff       	jmp    80105977 <alltraps>
...
80105fb1:	6a 28                	push   $0x28
  jmp alltraps
80105fb3:	e9 bf f9 ff ff       	jmp    80105977 <alltraps>
...
80105fba:	6a 29                	push   $0x29
  jmp alltraps
80105fbc:	e9 b6 f9 ff ff       	jmp    80105977 <alltraps>
...
80105fc3:	6a 2a                	push   $0x2a
  jmp alltraps
80105fc5:	e9 ad f9 ff ff       	jmp    80105977 <alltraps>
...
80105fcc:	6a 2b                	push   $0x2b
  jmp alltraps
80105fce:	e9 a4 f9 ff ff       	jmp    80105977 <alltraps>
...
80105fd5:	6a 2c                	push   $0x2c
  jmp alltraps
80105fd7:	e9 9b f9 ff ff       	jmp    80105977 <alltraps>
...
80105fde:	6a 2d                	push   $0x2d
  jmp alltraps
80105fe0:	e9 92 f9 ff ff       	jmp    80105977 <alltraps>
...
80105fe7:	6a 2e                	push   $0x2e
  jmp alltraps
80105fe9:	e9 89 f9 ff ff       	jmp    80105977 <alltraps>
...
80105ff0:	6a 2f                	push   $0x2f
  jmp alltraps
80105ff2:	e9 80 f9 ff ff       	jmp    80105977 <alltraps>
...
80105ff9:	6a 30                	push   $0x30
  jmp alltraps
80105ffb:	e9 77 f9 ff ff       	jmp    80105977 <alltraps>
...
80106002:	6a 31                	push   $0x31
  jmp alltraps
80106004:	e9 6e f9 ff ff       	jmp    80105977 <alltraps>
...
8010600b:	6a 32                	push   $0x32
  jmp alltraps
8010600d:	e9 65 f9 ff ff       	jmp    80105977 <alltraps>
...
80106014:	6a 33                	push   $0x33
  jmp alltraps
80106016:	e9 5c f9 ff ff       	jmp    80105977 <alltraps>
...
8010601d:	6a 34                	push   $0x34
  jmp alltraps
8010601f:	e9 53 f9 ff ff       	jmp    80105977 <alltraps>
...
80106026:	6a 35                	push   $0x35
  jmp alltraps
80106028:	e9 4a f9 ff ff       	jmp    80105977 <alltraps>
...
8010602f:	6a 36                	push   $0x36
  jmp alltraps
80106031:	e9 41 f9 ff ff       	jmp    80105977 <alltraps>
...
80106038:	6a 37                	push   $0x37
  jmp alltraps
8010603a:	e9 38 f9 ff ff       	jmp    80105977 <alltraps>
...
80106041:	6a 38                	push   $0x38
  jmp alltraps
80106043:	e9 2f f9 ff ff       	jmp    80105977 <alltraps>
...
8010604a:	6a 39                	push   $0x39
  jmp alltraps
8010604c:	e9 26 f9 ff ff       	jmp    80105977 <alltraps>
...
80106053:	6a 3a                	push   $0x3a
  jmp alltraps
80106055:	e9 1d f9 ff ff       	jmp    80105977 <alltraps>
...
8010605c:	6a 3b                	push   $0x3b
  jmp alltraps
8010605e:	e9 14 f9 ff ff       	jmp    80105977 <alltraps>
...
80106065:	6a 3c                	push   $0x3c
  jmp alltraps
80106067:	e9 0b f9 ff ff       	jmp    80105977 <alltraps>
...
8010606e:	6a 3d                	push   $0x3d
  jmp alltraps
80106070:	e9 02 f9 ff ff       	jmp    80105977 <alltraps>
...
80106077:	6a 3e                	push   $0x3e
  jmp alltraps
80106079:	e9 f9 f8 ff ff       	jmp    80105977 <alltraps>
...
80106080:	6a 3f                	push   $0x3f
  jmp alltraps
80106082:	e9 f0 f8 ff ff       	jmp    80105977 <alltraps>
...
80106089:	6a 40                	push   $0x40
  jmp alltraps
8010608b:	e9 e7 f8 ff ff       	jmp    80105977 <alltraps>
...
80106092:	6a 41                	push   $0x41
  jmp alltraps
80106094:	e9 de f8 ff ff       	jmp    80105977 <alltraps>
...
8010609b:	6a 42                	push   $0x42
  jmp alltraps
8010609d:	e9 d5 f8 ff ff       	jmp    80105977 <alltraps>
...
801060a4:	6a 43                	push   $0x43
  jmp alltraps
801060a6:	e9 cc f8 ff ff       	jmp    80105977 <alltraps>
...
801060ad:	6a 44                	push   $0x44
  jmp alltraps
801060af:	e9 c3 f8 ff ff       	jmp    80105977 <alltraps>
...
801060b6:	6a 45                	push   $0x45
  jmp alltraps
801060b8:	e9 ba f8 ff ff       	jmp    80105977 <alltraps>
...
801060bf:	6a 46                	push   $0x46
  jmp alltraps
801060c1:	e9 b1 f8 ff ff       	jmp    80105977 <alltraps>
...
801060c8:	6a 47                	push   $0x47
  jmp alltraps
801060ca:	e9 a8 f8 ff ff       	jmp    80105977 <alltraps>
...
801060d1:	6a 48                	push   $0x48
  jmp alltraps
801060d3:	e9 9f f8 ff ff       	jmp    80105977 <alltraps>
...
801060da:	6a 49                	push   $0x49
  jmp alltraps
801060dc:	e9 96 f8 ff ff       	jmp    80105977 <alltraps>
...
801060e3:	6a 4a                	push   $0x4a
  jmp alltraps
801060e5:	e9 8d f8 ff ff       	jmp    80105977 <alltraps>
...
801060ec:	6a 4b                	push   $0x4b
  jmp alltraps
801060ee:	e9 84 f8 ff ff       	jmp    80105977 <alltraps>
...
801060f5:	6a 4c                	push   $0x4c
  jmp alltraps
801060f7:	e9 7b f8 ff ff       	jmp    80105977 <alltraps>
...
801060fe:	6a 4d                	push   $0x4d
  jmp alltraps
80106100:	e9 72 f8 ff ff       	jmp    80105977 <alltraps>
...
80106107:	6a 4e                	push   $0x4e
  jmp alltraps
80106109:	e9 69 f8 ff ff       	jmp    80105977 <alltraps>
...
80106110:	6a 4f                	push   $0x4f
  jmp alltraps
80106112:	e9 60 f8 ff ff       	jmp    80105977 <alltraps>
...
80106119:	6a 50                	push   $0x50
  jmp alltraps
8010611b:	e9 57 f8 ff ff       	jmp    80105977 <alltraps>
...
80106122:	6a 51                	push   $0x51
  jmp alltraps
80106124:	e9 4e f8 ff ff       	jmp    80105977 <alltraps>
...
8010612b:	6a 52                	push   $0x52
  jmp alltraps
8010612d:	e9 45 f8 ff ff       	jmp    80105977 <alltraps>
...
80106134:	6a 53                	push   $0x53
  jmp alltraps
80106136:	e9 3c f8 ff ff       	jmp    80105977 <alltraps>
...
8010613d:	6a 54                	push   $0x54
  jmp alltraps
8010613f:	e9 33 f8 ff ff       	jmp    80105977 <alltraps>
...
80106146:	6a 55                	push   $0x55
  jmp alltraps
80106148:	e9 2a f8 ff ff       	jmp    80105977 <alltraps>
...
8010614f:	6a 56                	push   $0x56
  jmp alltraps
80106151:	e9 21 f8 ff ff       	jmp    80105977 <alltraps>
...
80106158:	6a 57                	push   $0x57
  jmp alltraps
8010615a:	e9 18 f8 ff ff       	jmp    80105977 <alltraps>
...
80106161:	6a 58                	push   $0x58
  jmp alltraps
80106163:	e9 0f f8 ff ff       	jmp    80105977 <alltraps>
...
8010616a:	6a 59                	push   $0x59
  jmp alltraps
8010616c:	e9 06 f8 ff ff       	jmp    80105977 <alltraps>
...
80106173:	6a 5a                	push   $0x5a
  jmp alltraps
80106175:	e9 fd f7 ff ff       	jmp    80105977 <alltraps>
...
8010617c:	6a 5b                	push   $0x5b
  jmp alltraps
8010617e:	e9 f4 f7 ff ff       	jmp    80105977 <alltraps>
...
80106185:	6a 5c                	push   $0x5c
  jmp alltraps
80106187:	e9 eb f7 ff ff       	jmp    80105977 <alltraps>
...
8010618e:	6a 5d                	push   $0x5d
  jmp alltraps
80106190:	e9 e2 f7 ff ff       	jmp    80105977 <alltraps>
...
80106197:	6a 5e                	push   $0x5e
  jmp alltraps
80106199:	e9 d9 f7 ff ff       	jmp    80105977 <alltraps>
...
801061a0:	6a 5f                	push   $0x5f
  jmp alltraps
801061a2:	e9 d0 f7 ff ff       	jmp    80105977 <alltraps>
...
801061a9:	6a 60                	push   $0x60
  jmp alltraps
801061ab:	e9 c7 f7 ff ff       	jmp    80105977 <alltraps>
...
801061b2:	6a 61                	push   $0x61
  jmp alltraps
801061b4:	e9 be f7 ff ff       	jmp    80105977 <alltraps>
...
801061bb:	6a 62                	push   $0x62
  jmp alltraps
801061bd:	e9 b5 f7 ff ff       	jmp    80105977 <alltraps>
...
801061c4:	6a 63                	push   $0x63
  jmp alltraps
801061c6:	e9 ac f7 ff ff       	jmp    80105977 <alltraps>
...
801061cd:	6a 64                	push   $0x64
  jmp alltraps
801061cf:	e9 a3 f7 ff ff       	jmp    80105977 <alltraps>
...
801061d6:	6a 65                	push   $0x65
  jmp alltraps
801061d8:	e9 9a f7 ff ff       	jmp    80105977 <alltraps>
...
801061df:	6a 66                	push   $0x66
  jmp alltraps
801061e1:	e9 91 f7 ff ff       	jmp    80105977 <alltraps>
...
801061e8:	6a 67                	push   $0x67
  jmp alltraps
801061ea:	e9 88 f7 ff ff       	jmp    80105977 <alltraps>
...
801061f1:	6a 68                	push   $0x68
  jmp alltraps
801061f3:	e9 7f f7 ff ff       	jmp    80105977 <alltraps>
...
801061fa:	6a 69                	push   $0x69
  jmp alltraps
801061fc:	e9 76 f7 ff ff       	jmp    80105977 <alltraps>
...
80106203:	6a 6a                	push   $0x6a
  jmp alltraps
80106205:	e9 6d f7 ff ff       	jmp    80105977 <alltraps>
...
8010620c:	6a 6b                	push   $0x6b
  jmp alltraps
8010620e:	e9 64 f7 ff ff       	jmp    80105977 <alltraps>
...
80106215:	6a 6c                	push   $0x6c
  jmp alltraps
80106217:	e9 5b f7 ff ff       	jmp    80105977 <alltraps>
...
8010621e:	6a 6d                	push   $0x6d
  jmp alltraps
80106220:	e9 52 f7 ff ff       	jmp    80105977 <alltraps>
...
80106227:	6a 6e                	push   $0x6e
  jmp alltraps
80106229:	e9 49 f7 ff ff       	jmp    80105977 <alltraps>
...
80106230:	6a 6f                	push   $0x6f
  jmp alltraps
80106232:	e9 40 f7 ff ff       	jmp    80105977 <alltraps>
...
80106239:	6a 70                	push   $0x70
  jmp alltraps
8010623b:	e9 37 f7 ff ff       	jmp    80105977 <alltraps>
...
80106242:	6a 71                	push   $0x71
  jmp alltraps
80106244:	e9 2e f7 ff ff       	jmp    80105977 <alltraps>
...
8010624b:	6a 72                	push   $0x72
  jmp alltraps
8010624d:	e9 25 f7 ff ff       	jmp    80105977 <alltraps>
...
80106254:	6a 73                	push   $0x73
  jmp alltraps
80106256:	e9 1c f7 ff ff       	jmp    80105977 <alltraps>
...
8010625d:	6a 74                	push   $0x74
  jmp alltraps
8010625f:	e9 13 f7 ff ff       	jmp    80105977 <alltraps>
...
80106266:	6a 75                	push   $0x75
  jmp alltraps
80106268:	e9 0a f7 ff ff       	jmp    80105977 <alltraps>
...
8010626f:	6a 76                	push   $0x76
  jmp alltraps
80106271:	e9 01 f7 ff ff       	jmp    80105977 <alltraps>
...
80106278:	6a 77                	push   $0x77
  jmp alltraps
8010627a:	e9 f8 f6 ff ff       	jmp    80105977 <alltraps>
...
80106281:	6a 78                	push   $0x78
  jmp alltraps
80106283:	e9 ef f6 ff ff       	jmp    80105977 <alltraps>
...
8010628a:	6a 79                	push   $0x79
  jmp alltraps
8010628c:	e9 e6 f6 ff ff       	jmp    80105977 <alltraps>
...
80106293:	6a 7a                	push   $0x7a
  jmp alltraps
80106295:	e9 dd f6 ff ff       	jmp    80105977 <alltraps>
...
8010629c:	6a 7b                	push   $0x7b
  jmp alltraps
8010629e:	e9 d4 f6 ff ff       	jmp    80105977 <alltraps>
...
801062a5:	6a 7c                	push   $0x7c
  jmp alltraps
801062a7:	e9 cb f6 ff ff       	jmp    80105977 <alltraps>
...
801062ae:	6a 7d                	push   $0x7d
  jmp alltraps
801062b0:	e9 c2 f6 ff ff       	jmp    80105977 <alltraps>
...
801062b7:	6a 7e                	push   $0x7e
  jmp alltraps
801062b9:	e9 b9 f6 ff ff       	jmp    80105977 <alltraps>
...
801062c0:	6a 7f                	push   $0x7f
  jmp alltraps
801062c2:	e9 b0 f6 ff ff       	jmp    80105977 <alltraps>
...
801062c9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801062ce:	e9 a4 f6 ff ff       	jmp    80105977 <alltraps>
...
801062d5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801062da:	e9 98 f6 ff ff       	jmp    80105977 <alltraps>
...
801062e1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801062e6:	e9 8c f6 ff ff       	jmp    80105977 <alltraps>
...
801062ed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801062f2:	e9 80 f6 ff ff       	jmp    80105977 <alltraps>
...
801062f9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801062fe:	e9 74 f6 ff ff       	jmp    80105977 <alltraps>
...
80106305:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010630a:	e9 68 f6 ff ff       	jmp    80105977 <alltraps>
...
80106311:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106316:	e9 5c f6 ff ff       	jmp    80105977 <alltraps>
...
8010631d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106322:	e9 50 f6 ff ff       	jmp    80105977 <alltraps>
...
80106329:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010632e:	e9 44 f6 ff ff       	jmp    80105977 <alltraps>
...
80106335:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010633a:	e9 38 f6 ff ff       	jmp    80105977 <alltraps>
...
80106341:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106346:	e9 2c f6 ff ff       	jmp    80105977 <alltraps>
...
8010634d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106352:	e9 20 f6 ff ff       	jmp    80105977 <alltraps>
...
80106359:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010635e:	e9 14 f6 ff ff       	jmp    80105977 <alltraps>
...
80106365:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010636a:	e9 08 f6 ff ff       	jmp    80105977 <alltraps>
...
80106371:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106376:	e9 fc f5 ff ff       	jmp    80105977 <alltraps>
...
8010637d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106382:	e9 f0 f5 ff ff       	jmp    80105977 <alltraps>
...
80106389:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010638e:	e9 e4 f5 ff ff       	jmp    80105977 <alltraps>
...
80106395:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010639a:	e9 d8 f5 ff ff       	jmp    80105977 <alltraps>
...
801063a1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801063a6:	e9 cc f5 ff ff       	jmp    80105977 <alltraps>
...
801063ad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801063b2:	e9 c0 f5 ff ff       	jmp    80105977 <alltraps>
...
801063b9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801063be:	e9 b4 f5 ff ff       	jmp    80105977 <alltraps>
...
801063c5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801063ca:	e9 a8 f5 ff ff       	jmp    80105977 <alltraps>
...
801063d1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801063d6:	e9 9c f5 ff ff       	jmp    80105977 <alltraps>
...
801063dd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801063e2:	e9 90 f5 ff ff       	jmp    80105977 <alltraps>
...
801063e9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801063ee:	e9 84 f5 ff ff       	jmp    80105977 <alltraps>
...
801063f5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801063fa:	e9 78 f5 ff ff       	jmp    80105977 <alltraps>
...
80106401:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106406:	e9 6c f5 ff ff       	jmp    80105977 <alltraps>
...
8010640d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106412:	e9 60 f5 ff ff       	jmp    80105977 <alltraps>
...
80106419:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010641e:	e9 54 f5 ff ff       	jmp    80105977 <alltraps>
...
80106425:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010642a:	e9 48 f5 ff ff       	jmp    80105977 <alltraps>
...
80106431:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106436:	e9 3c f5 ff ff       	jmp    80105977 <alltraps>
...
8010643d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106442:	e9 30 f5 ff ff       	jmp    80105977 <alltraps>
...
80106449:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010644e:	e9 24 f5 ff ff       	jmp    80105977 <alltraps>
...
80106455:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010645a:	e9 18 f5 ff ff       	jmp    80105977 <alltraps>
...
80106461:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106466:	e9 0c f5 ff ff       	jmp    80105977 <alltraps>
...
8010646d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106472:	e9 00 f5 ff ff       	jmp    80105977 <alltraps>
...
80106479:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010647e:	e9 f4 f4 ff ff       	jmp    80105977 <alltraps>
...
80106485:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010648a:	e9 e8 f4 ff ff       	jmp    80105977 <alltraps>
...
80106491:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106496:	e9 dc f4 ff ff       	jmp    80105977 <alltraps>
...
8010649d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801064a2:	e9 d0 f4 ff ff       	jmp    80105977 <alltraps>
...
801064a9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801064ae:	e9 c4 f4 ff ff       	jmp    80105977 <alltraps>
...
801064b5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801064ba:	e9 b8 f4 ff ff       	jmp    80105977 <alltraps>
...
801064c1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801064c6:	e9 ac f4 ff ff       	jmp    80105977 <alltraps>
...
801064cd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801064d2:	e9 a0 f4 ff ff       	jmp    80105977 <alltraps>
...
801064d9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801064de:	e9 94 f4 ff ff       	jmp    80105977 <alltraps>
...
801064e5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801064ea:	e9 88 f4 ff ff       	jmp    80105977 <alltraps>
...
801064f1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801064f6:	e9 7c f4 ff ff       	jmp    80105977 <alltraps>
...
801064fd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106502:	e9 70 f4 ff ff       	jmp    80105977 <alltraps>
...
80106509:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010650e:	e9 64 f4 ff ff       	jmp    80105977 <alltraps>
...
80106515:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010651a:	e9 58 f4 ff ff       	jmp    80105977 <alltraps>
...
80106521:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106526:	e9 4c f4 ff ff       	jmp    80105977 <alltraps>
...
8010652d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106532:	e9 40 f4 ff ff       	jmp    80105977 <alltraps>
...
80106539:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010653e:	e9 34 f4 ff ff       	jmp    80105977 <alltraps>
...
80106545:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010654a:	e9 28 f4 ff ff       	jmp    80105977 <alltraps>
...
80106551:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106556:	e9 1c f4 ff ff       	jmp    80105977 <alltraps>
...
8010655d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106562:	e9 10 f4 ff ff       	jmp    80105977 <alltraps>
...
80106569:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010656e:	e9 04 f4 ff ff       	jmp    80105977 <alltraps>
...
80106575:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010657a:	e9 f8 f3 ff ff       	jmp    80105977 <alltraps>
...
80106581:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106586:	e9 ec f3 ff ff       	jmp    80105977 <alltraps>
...
8010658d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106592:	e9 e0 f3 ff ff       	jmp    80105977 <alltraps>
...
80106599:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010659e:	e9 d4 f3 ff ff       	jmp    80105977 <alltraps>
...
801065a5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801065aa:	e9 c8 f3 ff ff       	jmp    80105977 <alltraps>
...
801065b1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801065b6:	e9 bc f3 ff ff       	jmp    80105977 <alltraps>
...
801065bd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801065c2:	e9 b0 f3 ff ff       	jmp    80105977 <alltraps>
...
801065c9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801065ce:	e9 a4 f3 ff ff       	jmp    80105977 <alltraps>
...
801065d5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801065da:	e9 98 f3 ff ff       	jmp    80105977 <alltraps>
...
801065e1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801065e6:	e9 8c f3 ff ff       	jmp    80105977 <alltraps>
...
801065ed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801065f2:	e9 80 f3 ff ff       	jmp    80105977 <alltraps>
...
801065f9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801065fe:	e9 74 f3 ff ff       	jmp    80105977 <alltraps>
...
80106605:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010660a:	e9 68 f3 ff ff       	jmp    80105977 <alltraps>
...
80106611:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106616:	e9 5c f3 ff ff       	jmp    80105977 <alltraps>
...
8010661d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106622:	e9 50 f3 ff ff       	jmp    80105977 <alltraps>
...
80106629:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010662e:	e9 44 f3 ff ff       	jmp    80105977 <alltraps>
...
80106635:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010663a:	e9 38 f3 ff ff       	jmp    80105977 <alltraps>
...
80106641:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106646:	e9 2c f3 ff ff       	jmp    80105977 <alltraps>
...
8010664d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106652:	e9 20 f3 ff ff       	jmp    80105977 <alltraps>
...
80106659:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010665e:	e9 14 f3 ff ff       	jmp    80105977 <alltraps>
...
80106665:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010666a:	e9 08 f3 ff ff       	jmp    80105977 <alltraps>
...
80106671:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106676:	e9 fc f2 ff ff       	jmp    80105977 <alltraps>
...
8010667d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106682:	e9 f0 f2 ff ff       	jmp    80105977 <alltraps>
...
80106689:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010668e:	e9 e4 f2 ff ff       	jmp    80105977 <alltraps>
...
80106695:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010669a:	e9 d8 f2 ff ff       	jmp    80105977 <alltraps>
...
801066a1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801066a6:	e9 cc f2 ff ff       	jmp    80105977 <alltraps>
...
801066ad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801066b2:	e9 c0 f2 ff ff       	jmp    80105977 <alltraps>
...
801066b9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801066be:	e9 b4 f2 ff ff       	jmp    80105977 <alltraps>
...
801066c5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801066ca:	e9 a8 f2 ff ff       	jmp    80105977 <alltraps>
...
801066d1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801066d6:	e9 9c f2 ff ff       	jmp    80105977 <alltraps>
...
801066dd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801066e2:	e9 90 f2 ff ff       	jmp    80105977 <alltraps>
...
801066e9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801066ee:	e9 84 f2 ff ff       	jmp    80105977 <alltraps>
...
801066f5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801066fa:	e9 78 f2 ff ff       	jmp    80105977 <alltraps>
...
80106701:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106706:	e9 6c f2 ff ff       	jmp    80105977 <alltraps>
...
8010670d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106712:	e9 60 f2 ff ff       	jmp    80105977 <alltraps>
...
80106719:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010671e:	e9 54 f2 ff ff       	jmp    80105977 <alltraps>
...
80106725:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010672a:	e9 48 f2 ff ff       	jmp    80105977 <alltraps>
...
80106731:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106736:	e9 3c f2 ff ff       	jmp    80105977 <alltraps>
...
8010673d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106742:	e9 30 f2 ff ff       	jmp    80105977 <alltraps>
...
80106749:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010674e:	e9 24 f2 ff ff       	jmp    80105977 <alltraps>
...
80106755:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010675a:	e9 18 f2 ff ff       	jmp    80105977 <alltraps>
...
80106761:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106766:	e9 0c f2 ff ff       	jmp    80105977 <alltraps>
...
8010676d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106772:	e9 00 f2 ff ff       	jmp    80105977 <alltraps>
...
80106779:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010677e:	e9 f4 f1 ff ff       	jmp    80105977 <alltraps>
...
80106785:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010678a:	e9 e8 f1 ff ff       	jmp    80105977 <alltraps>
...
80106791:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106796:	e9 dc f1 ff ff       	jmp    80105977 <alltraps>
...
8010679d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801067a2:	e9 d0 f1 ff ff       	jmp    80105977 <alltraps>
...
801067a9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801067ae:	e9 c4 f1 ff ff       	jmp    80105977 <alltraps>
...
801067b5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801067ba:	e9 b8 f1 ff ff       	jmp    80105977 <alltraps>
...
801067c1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801067c6:	e9 ac f1 ff ff       	jmp    80105977 <alltraps>
...
801067cd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801067d2:	e9 a0 f1 ff ff       	jmp    80105977 <alltraps>
...
801067d9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801067de:	e9 94 f1 ff ff       	jmp    80105977 <alltraps>
...
801067e5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801067ea:	e9 88 f1 ff ff       	jmp    80105977 <alltraps>
...
801067f1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801067f6:	e9 7c f1 ff ff       	jmp    80105977 <alltraps>
...
801067fd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106802:	e9 70 f1 ff ff       	jmp    80105977 <alltraps>
...
80106809:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010680e:	e9 64 f1 ff ff       	jmp    80105977 <alltraps>
...
80106815:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010681a:	e9 58 f1 ff ff       	jmp    80105977 <alltraps>
...
80106821:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106826:	e9 4c f1 ff ff       	jmp    80105977 <alltraps>
...
8010682d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106832:	e9 40 f1 ff ff       	jmp    80105977 <alltraps>
...
80106839:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010683e:	e9 34 f1 ff ff       	jmp    80105977 <alltraps>
...
80106845:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010684a:	e9 28 f1 ff ff       	jmp    80105977 <alltraps>
...
80106851:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106856:	e9 1c f1 ff ff       	jmp    80105977 <alltraps>
...
8010685d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106862:	e9 10 f1 ff ff       	jmp    80105977 <alltraps>
...
80106869:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010686e:	e9 04 f1 ff ff       	jmp    80105977 <alltraps>
...
80106875:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010687a:	e9 f8 f0 ff ff       	jmp    80105977 <alltraps>
...
80106881:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106886:	e9 ec f0 ff ff       	jmp    80105977 <alltraps>
...
8010688d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106892:	e9 e0 f0 ff ff       	jmp    80105977 <alltraps>
...
80106899:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010689e:	e9 d4 f0 ff ff       	jmp    80105977 <alltraps>
...
801068a5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801068aa:	e9 c8 f0 ff ff       	jmp    80105977 <alltraps>
...
801068b1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801068b6:	e9 bc f0 ff ff       	jmp    80105977 <alltraps>
...
801068bd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801068c2:	e9 b0 f0 ff ff       	jmp    80105977 <alltraps>
...
801069cd:	68 78 7b 10 80       	push   $0x80107b78
...
80106a83:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a86:	e8 35 cd ff ff       	call   801037c0 <cpuid>
...
80106b10:	a1 84 56 11 80       	mov    0x80115684,%eax
{
...
80106b54:	0f 84 c2 00 00 00    	je     80106c1c <switchuvm+0xec>
  pushcli();
80106b5a:	e8 81 d8 ff ff       	call   801043e0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b5f:	e8 dc cb ff ff       	call   80103740 <mycpu>
80106b64:	89 c6                	mov    %eax,%esi
80106b66:	e8 d5 cb ff ff       	call   80103740 <mycpu>
80106b6b:	89 c7                	mov    %eax,%edi
80106b6d:	e8 ce cb ff ff       	call   80103740 <mycpu>
80106b72:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b75:	83 c7 08             	add    $0x8,%edi
80106b78:	e8 c3 cb ff ff       	call   80103740 <mycpu>
...
80106ca9:	68 bd 7b 10 80       	push   $0x80107bbd
...
80106e0d:	68 f5 7b 10 80       	push   $0x80107bf5
...
80106e43:	68 0d 7c 10 80       	push   $0x80107c0d
...
80106f4c:	68 29 7c 10 80       	push   $0x80107c29
...
80106feb:	a3 84 56 11 80       	mov    %eax,0x80115684
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010701f:	68 3a 7c 10 80       	push   $0x80107c3a
...
80107109:	68 5e 7c 10 80       	push   $0x80107c5e
8010710e:	e8 7d 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107113:	83 ec 0c             	sub    $0xc,%esp
80107116:	68 44 7c 10 80       	push   $0x80107c44
