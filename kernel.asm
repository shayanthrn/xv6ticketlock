...
80102322:	81 fb e8 55 11 80    	cmp    $0x801155e8,%ebx
...
80103623:	81 fb 94 4d 11 80    	cmp    $0x80114d94,%ebx
...
80103644:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103647:	68 60 2d 11 80       	push   $0x80112d60
  p->pid = nextpid++;
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 01 58 10 80 	movl   $0x80105801,0x14(%eax)
  p->context = (struct context*)sp;
...
801036a3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036a5:	68 60 2d 11 80       	push   $0x80112d60
...
801036d3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036d6:	68 60 2d 11 80       	push   $0x80112d60
...
8010372b:	68 60 2d 11 80       	push   $0x80112d60
...
801037ad:	68 c4 76 10 80       	push   $0x801076c4
...
801038c6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801038c9:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
801038d0:	e8 cb 0a 00 00       	call   801043a0 <acquire>
  p->state = RUNNABLE;
801038d5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801038dc:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
...
80103a36:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a39:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
80103a40:	e8 5b 09 00 00       	call   801043a0 <acquire>
  np->state = RUNNABLE;
80103a45:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a4c:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
...
80103ac1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ac4:	bb 94 2d 11 80       	mov    $0x80112d94,%ebx
    acquire(&ptable.lock);
80103ac9:	68 60 2d 11 80       	push   $0x80112d60
...
80103b1c:	81 fb 94 4d 11 80    	cmp    $0x80114d94,%ebx
80103b22:	72 bc                	jb     80103ae0 <scheduler+0x40>
    release(&ptable.lock);
80103b24:	83 ec 0c             	sub    $0xc,%esp
80103b27:	68 60 2d 11 80       	push   $0x80112d60
...
80103b5d:	68 60 2d 11 80       	push   $0x80112d60
...
80103c64:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103c6b:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
...
80103cd7:	75 e7                	jne    80103cc0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cd9:	b8 94 2d 11 80       	mov    $0x80112d94,%eax
80103cde:	eb 0a                	jmp    80103cea <exit+0xea>
80103ce0:	83 e8 80             	sub    $0xffffff80,%eax
80103ce3:	3d 94 4d 11 80       	cmp    $0x80114d94,%eax
...
80103d37:	68 60 2d 11 80       	push   $0x80112d60
...
80103d5d:	e8 de fd ff ff       	call   80103b40 <sched>
  release(&ptable.lock);
80103d62:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
...
80103db0:	81 fe 60 2d 11 80    	cmp    $0x80112d60,%esi
80103db6:	74 50                	je     80103e08 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103db8:	83 ec 0c             	sub    $0xc,%esp
80103dbb:	68 60 2d 11 80       	push   $0x80112d60
...
80103ddc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103de3:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
...
80103e91:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e96:	81 fb 94 4d 11 80    	cmp    $0x80114d94,%ebx
...
80103eac:	68 60 2d 11 80       	push   $0x80112d60
...
80103ed9:	e8 72 2e 00 00       	call   80106d50 <freevm>
        release(&ptable.lock);
80103ede:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
        p->pid = 0;
...
80103f19:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f1e:	68 60 2d 11 80       	push   $0x80112d60
...
80103f6f:	3d 94 4d 11 80       	cmp    $0x80114d94,%eax
80103f74:	72 e4                	jb     80103f5a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80103f76:	c7 45 08 60 2d 11 80 	movl   $0x80112d60,0x8(%ebp)
}
...
80103fd6:	68 60 2d 11 80       	push   $0x80112d60
80103fdb:	e8 80 04 00 00       	call   80104460 <release>
      return 0;
...
80103ff3:	68 60 2d 11 80       	push   $0x80112d60
80103ff8:	e8 63 04 00 00       	call   80104460 <release>
  return -1;
...
80104016:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104019:	bb 94 2d 11 80       	mov    $0x80112d94,%ebx
{
...
80104058:	8b 14 85 18 77 10 80 	mov    -0x7fef88e8(,%eax,4),%edx
      state = "???";
...
801040e0:	e8 cb 03 00 00       	call   801044b0 <initlockticket>
  return 0;
}
...
801040fb:	e8 20 04 00 00       	call   80104520 <acquireticket>
  cprintf("ticket number is : %d and index is : %d \n",lk.ticket,lk.index);
80104100:	83 c4 0c             	add    $0xc,%esp
80104103:	ff 35 24 2d 11 80    	pushl  0x80112d24
80104109:	ff 35 20 2d 11 80    	pushl  0x80112d20
8010410f:	68 ec 76 10 80       	push   $0x801076ec
80104114:	e8 47 c5 ff ff       	call   80100660 <cprintf>
  releaseticket(&lk);
80104119:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104120:	e8 7b 04 00 00       	call   801045a0 <releaseticket>
  return 0;
...
8010413a:	68 30 77 10 80       	push   $0x80107730
...
80104355:	68 3b 77 10 80       	push   $0x8010773b
8010435a:	e8 31 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010435f:	83 ec 0c             	sub    $0xc,%esp
80104362:	68 52 77 10 80       	push   $0x80107752
...
80104447:	68 59 77 10 80       	push   $0x80107759
...
8010449c:	68 61 77 10 80       	push   $0x80107761
...
801044b9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->name = name;
801044bf:	89 50 08             	mov    %edx,0x8(%eax)
  lk->index = -1;
801044c2:	c7 40 04 ff ff ff ff 	movl   $0xffffffff,0x4(%eax)
  lk->cpu = 0;
...
801044e8:	31 f6                	xor    %esi,%esi
  int r;
  pushcli();
801044ea:	e8 e1 fd ff ff       	call   801042d0 <pushcli>
  r = lock->index>=lock->ticket && lock->cpu == mycpu();
801044ef:	8b 03                	mov    (%ebx),%eax
801044f1:	39 43 04             	cmp    %eax,0x4(%ebx)
801044f4:	7c 12                	jl     80104508 <holdingticket+0x28>
801044f6:	8b 5b 0c             	mov    0xc(%ebx),%ebx
801044f9:	e8 42 f2 ff ff       	call   80103740 <mycpu>
801044fe:	39 c3                	cmp    %eax,%ebx
80104500:	0f 94 c0             	sete   %al
80104503:	0f b6 c0             	movzbl %al,%eax
80104506:	89 c6                	mov    %eax,%esi
  popcli();
80104508:	e8 03 fe ff ff       	call   80104310 <popcli>
  return r;
}
8010450d:	89 f0                	mov    %esi,%eax
8010450f:	5b                   	pop    %ebx
80104510:	5e                   	pop    %esi
80104511:	5d                   	pop    %ebp
80104512:	c3                   	ret    
...
80104524:	83 ec 04             	sub    $0x4,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80104527:	e8 a4 fd ff ff       	call   801042d0 <pushcli>
  if(holdingticket(lk))
8010452c:	83 ec 0c             	sub    $0xc,%esp
8010452f:	ff 75 08             	pushl  0x8(%ebp)
80104532:	e8 a9 ff ff ff       	call   801044e0 <holdingticket>
80104537:	83 c4 10             	add    $0x10,%esp
8010453a:	85 c0                	test   %eax,%eax
8010453c:	75 54                	jne    80104592 <acquireticket+0x72>
  myproc()->ticket=fetch_and_add(&lk->index,1);  
8010453e:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104541:	e8 9a f2 ff ff       	call   801037e0 <myproc>
}
...
80104546:	ba 01 00 00 00       	mov    $0x1,%edx
8010454b:	f0 0f c1 53 04       	lock xadd %edx,0x4(%ebx)
80104550:	89 50 7c             	mov    %edx,0x7c(%eax)
80104553:	90                   	nop
80104554:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while(myproc()->ticket!=lk->ticket);
80104558:	e8 83 f2 ff ff       	call   801037e0 <myproc>
8010455d:	8b 55 08             	mov    0x8(%ebp),%edx
80104560:	8b 0a                	mov    (%edx),%ecx
80104562:	39 48 7c             	cmp    %ecx,0x7c(%eax)
80104565:	75 f1                	jne    80104558 <acquireticket+0x38>
  __sync_synchronize();
80104567:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
8010456c:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010456f:	e8 cc f1 ff ff       	call   80103740 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104574:	83 ec 08             	sub    $0x8,%esp
  lk->cpu = mycpu();
80104577:	89 43 0c             	mov    %eax,0xc(%ebx)
  getcallerpcs(&lk, lk->pcs);
8010457a:	8b 45 08             	mov    0x8(%ebp),%eax
8010457d:	83 c0 10             	add    $0x10,%eax
80104580:	50                   	push   %eax
80104581:	8d 45 08             	lea    0x8(%ebp),%eax
80104584:	50                   	push   %eax
80104585:	e8 f6 fc ff ff       	call   80104280 <getcallerpcs>
}
...
80104595:	68 69 77 10 80       	push   $0x80107769
8010459a:	e8 f1 bd ff ff       	call   80100390 <panic>
8010459f:	90                   	nop

801045a0 <releaseticket>:
{
...
801045ab:	e8 30 ff ff ff       	call   801044e0 <holdingticket>
801045b0:	83 c4 10             	add    $0x10,%esp
801045b3:	85 c0                	test   %eax,%eax
801045b5:	74 25                	je     801045dc <releaseticket+0x3c>
  lk->pcs[0] = 0;
801045b7:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
  lk->cpu = 0;
801045be:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
801045c5:	b8 01 00 00 00       	mov    $0x1,%eax
  __sync_synchronize();
801045ca:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
801045cf:	f0 0f c1 03          	lock xadd %eax,(%ebx)
}
801045d3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801045d6:	c9                   	leave  
  popcli();
801045d7:	e9 34 fd ff ff       	jmp    80104310 <popcli>
    panic("releaseticket");
801045dc:	83 ec 0c             	sub    $0xc,%esp
801045df:	68 77 77 10 80       	push   $0x80107777
801045e4:	e8 a7 bd ff ff       	call   80100390 <panic>
...
801049fc:	8b 14 85 c0 77 10 80 	mov    -0x7fef8840(,%eax,4),%edx
...
80104a20:	68 85 77 10 80       	push   $0x80107785
...
80104b74:	68 3c 78 10 80       	push   $0x8010783c
...
80104b8c:	68 3b 78 10 80       	push   $0x8010783b
...
80104ba5:	68 2f 78 10 80       	push   $0x8010782f
...
80104bba:	68 3e 78 10 80       	push   $0x8010783e
80104bbf:	e8 cc b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104bc4:	83 ec 0c             	sub    $0xc,%esp
80104bc7:	68 20 78 10 80       	push   $0x80107820
...
80104fb9:	58                   	pop    %eax
80104fba:	5a                   	pop    %edx
80104fbb:	68 3c 78 10 80       	push   $0x8010783c
...
80104fd4:	68 3b 78 10 80       	push   $0x8010783b
...
80105710:	68 a0 4d 11 80       	push   $0x80114da0
80105715:	e8 86 ec ff ff       	call   801043a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010571a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010571d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105720:	8b 1d e0 55 11 80    	mov    0x801155e0,%ebx
  while(ticks - ticks0 < n){
...
80105733:	68 a0 4d 11 80       	push   $0x80114da0
80105738:	68 e0 55 11 80       	push   $0x801155e0
8010573d:	e8 3e e6 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
80105742:	a1 e0 55 11 80       	mov    0x801155e0,%eax
...
80105760:	68 a0 4d 11 80       	push   $0x80114da0
80105765:	e8 f6 ec ff ff       	call   80104460 <release>
      return -1;
...
80105783:	68 a0 4d 11 80       	push   $0x80114da0
80105788:	e8 d3 ec ff ff       	call   80104460 <release>
  return 0;
...
801057a4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801057a7:	68 a0 4d 11 80       	push   $0x80114da0
801057ac:	e8 ef eb ff ff       	call   801043a0 <acquire>
  xticks = ticks;
801057b1:	8b 1d e0 55 11 80    	mov    0x801155e0,%ebx
  release(&tickslock);
801057b7:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801057be:	e8 9d ec ff ff       	call   80104460 <release>
  return xticks;
}
...
801057d3:	5d                   	pop    %ebp
  return ticketlockInit();
801057d4:	e9 f7 e8 ff ff       	jmp    801040d0 <ticketlockInit>
...
801057e3:	5d                   	pop    %ebp
  return ticketlockTest();
801057e4:	e9 07 e9 ff ff       	jmp    801040f0 <ticketlockTest>
...
80105827:	c7 04 c5 e2 4d 11 80 	movl   $0x8e000008,-0x7feeb21e(,%eax,8)
8010582e:	08 00 00 8e 
80105832:	66 89 14 c5 e0 4d 11 	mov    %dx,-0x7feeb220(,%eax,8)
80105839:	80 
8010583a:	c1 ea 10             	shr    $0x10,%edx
8010583d:	66 89 14 c5 e6 4d 11 	mov    %dx,-0x7feeb21a(,%eax,8)
80105844:	80 
  for(i = 0; i < 256; i++)
...
80105854:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105857:	c7 05 e2 4f 11 80 08 	movl   $0xef000008,0x80114fe2
8010585e:	00 00 ef 
  initlock(&tickslock, "time");
80105861:	68 81 78 10 80       	push   $0x80107881
80105866:	68 a0 4d 11 80       	push   $0x80114da0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010586b:	66 a3 e0 4f 11 80    	mov    %ax,0x80114fe0
80105871:	c1 e8 10             	shr    $0x10,%eax
80105874:	66 a3 e6 4f 11 80    	mov    %ax,0x80114fe6
  initlock(&tickslock, "time");
8010587a:	e8 e1 e9 ff ff       	call   80104260 <initlock>
}
...
8010589b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010589f:	b8 e0 4d 11 80       	mov    $0x80114de0,%eax
...
801058e0:	ff 24 85 28 79 10 80 	jmp    *-0x7fef86d8(,%eax,4)
...
80105945:	68 e4 78 10 80       	push   $0x801078e4
...
801059dd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801059e0:	e8 fb ef ff ff       	call   801049e0 <syscall>
    if(myproc()->killed)
...
80105a87:	68 8c 78 10 80       	push   $0x8010788c
...
80105ae3:	68 a0 4d 11 80       	push   $0x80114da0
80105ae8:	e8 b3 e8 ff ff       	call   801043a0 <acquire>
      wakeup(&ticks);
80105aed:	c7 04 24 e0 55 11 80 	movl   $0x801155e0,(%esp)
      ticks++;
80105af4:	83 05 e0 55 11 80 01 	addl   $0x1,0x801155e0
      wakeup(&ticks);
80105afb:	e8 30 e4 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
80105b00:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80105b07:	e8 54 e9 ff ff       	call   80104460 <release>
...
80105b25:	68 b0 78 10 80       	push   $0x801078b0
80105b2a:	e8 31 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105b2f:	83 c4 14             	add    $0x14,%esp
80105b32:	68 86 78 10 80       	push   $0x80107886
...
80105c2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c2f:	bb a8 79 10 80       	mov    $0x801079a8,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105cc7:	6a 00                	push   $0x0
  jmp alltraps
80105cc9:	e9 1b fb ff ff       	jmp    801057e9 <alltraps>
...
80105cd0:	6a 01                	push   $0x1
  jmp alltraps
80105cd2:	e9 12 fb ff ff       	jmp    801057e9 <alltraps>
...
80105cd9:	6a 02                	push   $0x2
  jmp alltraps
80105cdb:	e9 09 fb ff ff       	jmp    801057e9 <alltraps>
...
80105ce2:	6a 03                	push   $0x3
  jmp alltraps
80105ce4:	e9 00 fb ff ff       	jmp    801057e9 <alltraps>
...
80105ceb:	6a 04                	push   $0x4
  jmp alltraps
80105ced:	e9 f7 fa ff ff       	jmp    801057e9 <alltraps>
...
80105cf4:	6a 05                	push   $0x5
  jmp alltraps
80105cf6:	e9 ee fa ff ff       	jmp    801057e9 <alltraps>
...
80105cfd:	6a 06                	push   $0x6
  jmp alltraps
80105cff:	e9 e5 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d06:	6a 07                	push   $0x7
  jmp alltraps
80105d08:	e9 dc fa ff ff       	jmp    801057e9 <alltraps>
...
80105d0d:	6a 08                	push   $0x8
  jmp alltraps
80105d0f:	e9 d5 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d16:	6a 09                	push   $0x9
  jmp alltraps
80105d18:	e9 cc fa ff ff       	jmp    801057e9 <alltraps>
...
80105d1d:	6a 0a                	push   $0xa
  jmp alltraps
80105d1f:	e9 c5 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d24:	6a 0b                	push   $0xb
  jmp alltraps
80105d26:	e9 be fa ff ff       	jmp    801057e9 <alltraps>
...
80105d2b:	6a 0c                	push   $0xc
  jmp alltraps
80105d2d:	e9 b7 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d39:	6a 0e                	push   $0xe
  jmp alltraps
80105d3b:	e9 a9 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d42:	6a 0f                	push   $0xf
  jmp alltraps
80105d44:	e9 a0 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d4b:	6a 10                	push   $0x10
  jmp alltraps
80105d4d:	e9 97 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d52:	6a 11                	push   $0x11
  jmp alltraps
80105d54:	e9 90 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d5b:	6a 12                	push   $0x12
  jmp alltraps
80105d5d:	e9 87 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d64:	6a 13                	push   $0x13
  jmp alltraps
80105d66:	e9 7e fa ff ff       	jmp    801057e9 <alltraps>
...
80105d76:	6a 15                	push   $0x15
  jmp alltraps
80105d78:	e9 6c fa ff ff       	jmp    801057e9 <alltraps>
...
80105d7f:	6a 16                	push   $0x16
  jmp alltraps
80105d81:	e9 63 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d88:	6a 17                	push   $0x17
  jmp alltraps
80105d8a:	e9 5a fa ff ff       	jmp    801057e9 <alltraps>
...
80105d91:	6a 18                	push   $0x18
  jmp alltraps
80105d93:	e9 51 fa ff ff       	jmp    801057e9 <alltraps>
...
80105d9a:	6a 19                	push   $0x19
  jmp alltraps
80105d9c:	e9 48 fa ff ff       	jmp    801057e9 <alltraps>
...
80105da3:	6a 1a                	push   $0x1a
  jmp alltraps
80105da5:	e9 3f fa ff ff       	jmp    801057e9 <alltraps>
...
80105dac:	6a 1b                	push   $0x1b
  jmp alltraps
80105dae:	e9 36 fa ff ff       	jmp    801057e9 <alltraps>
...
80105db5:	6a 1c                	push   $0x1c
  jmp alltraps
80105db7:	e9 2d fa ff ff       	jmp    801057e9 <alltraps>
...
80105dbe:	6a 1d                	push   $0x1d
  jmp alltraps
80105dc0:	e9 24 fa ff ff       	jmp    801057e9 <alltraps>
...
80105dc7:	6a 1e                	push   $0x1e
  jmp alltraps
80105dc9:	e9 1b fa ff ff       	jmp    801057e9 <alltraps>
...
80105dd0:	6a 1f                	push   $0x1f
  jmp alltraps
80105dd2:	e9 12 fa ff ff       	jmp    801057e9 <alltraps>
...
80105dd9:	6a 20                	push   $0x20
  jmp alltraps
80105ddb:	e9 09 fa ff ff       	jmp    801057e9 <alltraps>
...
80105de2:	6a 21                	push   $0x21
  jmp alltraps
80105de4:	e9 00 fa ff ff       	jmp    801057e9 <alltraps>
...
80105deb:	6a 22                	push   $0x22
  jmp alltraps
80105ded:	e9 f7 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105df4:	6a 23                	push   $0x23
  jmp alltraps
80105df6:	e9 ee f9 ff ff       	jmp    801057e9 <alltraps>
...
80105dfd:	6a 24                	push   $0x24
  jmp alltraps
80105dff:	e9 e5 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e06:	6a 25                	push   $0x25
  jmp alltraps
80105e08:	e9 dc f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e0f:	6a 26                	push   $0x26
  jmp alltraps
80105e11:	e9 d3 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e18:	6a 27                	push   $0x27
  jmp alltraps
80105e1a:	e9 ca f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e21:	6a 28                	push   $0x28
  jmp alltraps
80105e23:	e9 c1 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e2a:	6a 29                	push   $0x29
  jmp alltraps
80105e2c:	e9 b8 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e33:	6a 2a                	push   $0x2a
  jmp alltraps
80105e35:	e9 af f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e3c:	6a 2b                	push   $0x2b
  jmp alltraps
80105e3e:	e9 a6 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e45:	6a 2c                	push   $0x2c
  jmp alltraps
80105e47:	e9 9d f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e4e:	6a 2d                	push   $0x2d
  jmp alltraps
80105e50:	e9 94 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e57:	6a 2e                	push   $0x2e
  jmp alltraps
80105e59:	e9 8b f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e60:	6a 2f                	push   $0x2f
  jmp alltraps
80105e62:	e9 82 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e69:	6a 30                	push   $0x30
  jmp alltraps
80105e6b:	e9 79 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e72:	6a 31                	push   $0x31
  jmp alltraps
80105e74:	e9 70 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e7b:	6a 32                	push   $0x32
  jmp alltraps
80105e7d:	e9 67 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e84:	6a 33                	push   $0x33
  jmp alltraps
80105e86:	e9 5e f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e8d:	6a 34                	push   $0x34
  jmp alltraps
80105e8f:	e9 55 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e96:	6a 35                	push   $0x35
  jmp alltraps
80105e98:	e9 4c f9 ff ff       	jmp    801057e9 <alltraps>
...
80105e9f:	6a 36                	push   $0x36
  jmp alltraps
80105ea1:	e9 43 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105ea8:	6a 37                	push   $0x37
  jmp alltraps
80105eaa:	e9 3a f9 ff ff       	jmp    801057e9 <alltraps>
...
80105eb1:	6a 38                	push   $0x38
  jmp alltraps
80105eb3:	e9 31 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105eba:	6a 39                	push   $0x39
  jmp alltraps
80105ebc:	e9 28 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105ec3:	6a 3a                	push   $0x3a
  jmp alltraps
80105ec5:	e9 1f f9 ff ff       	jmp    801057e9 <alltraps>
...
80105ecc:	6a 3b                	push   $0x3b
  jmp alltraps
80105ece:	e9 16 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105ed5:	6a 3c                	push   $0x3c
  jmp alltraps
80105ed7:	e9 0d f9 ff ff       	jmp    801057e9 <alltraps>
...
80105ede:	6a 3d                	push   $0x3d
  jmp alltraps
80105ee0:	e9 04 f9 ff ff       	jmp    801057e9 <alltraps>
...
80105ee7:	6a 3e                	push   $0x3e
  jmp alltraps
80105ee9:	e9 fb f8 ff ff       	jmp    801057e9 <alltraps>
...
80105ef0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ef2:	e9 f2 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105ef9:	6a 40                	push   $0x40
  jmp alltraps
80105efb:	e9 e9 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f02:	6a 41                	push   $0x41
  jmp alltraps
80105f04:	e9 e0 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f0b:	6a 42                	push   $0x42
  jmp alltraps
80105f0d:	e9 d7 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f14:	6a 43                	push   $0x43
  jmp alltraps
80105f16:	e9 ce f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f1d:	6a 44                	push   $0x44
  jmp alltraps
80105f1f:	e9 c5 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f26:	6a 45                	push   $0x45
  jmp alltraps
80105f28:	e9 bc f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f2f:	6a 46                	push   $0x46
  jmp alltraps
80105f31:	e9 b3 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f38:	6a 47                	push   $0x47
  jmp alltraps
80105f3a:	e9 aa f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f41:	6a 48                	push   $0x48
  jmp alltraps
80105f43:	e9 a1 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f4a:	6a 49                	push   $0x49
  jmp alltraps
80105f4c:	e9 98 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f53:	6a 4a                	push   $0x4a
  jmp alltraps
80105f55:	e9 8f f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f5c:	6a 4b                	push   $0x4b
  jmp alltraps
80105f5e:	e9 86 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f65:	6a 4c                	push   $0x4c
  jmp alltraps
80105f67:	e9 7d f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f6e:	6a 4d                	push   $0x4d
  jmp alltraps
80105f70:	e9 74 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f77:	6a 4e                	push   $0x4e
  jmp alltraps
80105f79:	e9 6b f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f80:	6a 4f                	push   $0x4f
  jmp alltraps
80105f82:	e9 62 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f89:	6a 50                	push   $0x50
  jmp alltraps
80105f8b:	e9 59 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f92:	6a 51                	push   $0x51
  jmp alltraps
80105f94:	e9 50 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105f9b:	6a 52                	push   $0x52
  jmp alltraps
80105f9d:	e9 47 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105fa4:	6a 53                	push   $0x53
  jmp alltraps
80105fa6:	e9 3e f8 ff ff       	jmp    801057e9 <alltraps>
...
80105fad:	6a 54                	push   $0x54
  jmp alltraps
80105faf:	e9 35 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105fb6:	6a 55                	push   $0x55
  jmp alltraps
80105fb8:	e9 2c f8 ff ff       	jmp    801057e9 <alltraps>
...
80105fbf:	6a 56                	push   $0x56
  jmp alltraps
80105fc1:	e9 23 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105fc8:	6a 57                	push   $0x57
  jmp alltraps
80105fca:	e9 1a f8 ff ff       	jmp    801057e9 <alltraps>
...
80105fd1:	6a 58                	push   $0x58
  jmp alltraps
80105fd3:	e9 11 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105fda:	6a 59                	push   $0x59
  jmp alltraps
80105fdc:	e9 08 f8 ff ff       	jmp    801057e9 <alltraps>
...
80105fe3:	6a 5a                	push   $0x5a
  jmp alltraps
80105fe5:	e9 ff f7 ff ff       	jmp    801057e9 <alltraps>
...
80105fec:	6a 5b                	push   $0x5b
  jmp alltraps
80105fee:	e9 f6 f7 ff ff       	jmp    801057e9 <alltraps>
...
80105ff5:	6a 5c                	push   $0x5c
  jmp alltraps
80105ff7:	e9 ed f7 ff ff       	jmp    801057e9 <alltraps>
...
80105ffe:	6a 5d                	push   $0x5d
  jmp alltraps
80106000:	e9 e4 f7 ff ff       	jmp    801057e9 <alltraps>
...
80106007:	6a 5e                	push   $0x5e
  jmp alltraps
80106009:	e9 db f7 ff ff       	jmp    801057e9 <alltraps>
...
80106010:	6a 5f                	push   $0x5f
  jmp alltraps
80106012:	e9 d2 f7 ff ff       	jmp    801057e9 <alltraps>
...
80106019:	6a 60                	push   $0x60
  jmp alltraps
8010601b:	e9 c9 f7 ff ff       	jmp    801057e9 <alltraps>
...
80106022:	6a 61                	push   $0x61
  jmp alltraps
80106024:	e9 c0 f7 ff ff       	jmp    801057e9 <alltraps>
...
8010602b:	6a 62                	push   $0x62
  jmp alltraps
8010602d:	e9 b7 f7 ff ff       	jmp    801057e9 <alltraps>
...
80106034:	6a 63                	push   $0x63
  jmp alltraps
80106036:	e9 ae f7 ff ff       	jmp    801057e9 <alltraps>
...
8010603d:	6a 64                	push   $0x64
  jmp alltraps
8010603f:	e9 a5 f7 ff ff       	jmp    801057e9 <alltraps>
...
80106046:	6a 65                	push   $0x65
  jmp alltraps
80106048:	e9 9c f7 ff ff       	jmp    801057e9 <alltraps>
...
8010604f:	6a 66                	push   $0x66
  jmp alltraps
80106051:	e9 93 f7 ff ff       	jmp    801057e9 <alltraps>
...
80106058:	6a 67                	push   $0x67
  jmp alltraps
8010605a:	e9 8a f7 ff ff       	jmp    801057e9 <alltraps>
...
80106061:	6a 68                	push   $0x68
  jmp alltraps
80106063:	e9 81 f7 ff ff       	jmp    801057e9 <alltraps>
...
8010606a:	6a 69                	push   $0x69
  jmp alltraps
8010606c:	e9 78 f7 ff ff       	jmp    801057e9 <alltraps>
...
80106073:	6a 6a                	push   $0x6a
  jmp alltraps
80106075:	e9 6f f7 ff ff       	jmp    801057e9 <alltraps>
...
8010607c:	6a 6b                	push   $0x6b
  jmp alltraps
8010607e:	e9 66 f7 ff ff       	jmp    801057e9 <alltraps>
...
80106085:	6a 6c                	push   $0x6c
  jmp alltraps
80106087:	e9 5d f7 ff ff       	jmp    801057e9 <alltraps>
...
8010608e:	6a 6d                	push   $0x6d
  jmp alltraps
80106090:	e9 54 f7 ff ff       	jmp    801057e9 <alltraps>
...
80106097:	6a 6e                	push   $0x6e
  jmp alltraps
80106099:	e9 4b f7 ff ff       	jmp    801057e9 <alltraps>
...
801060a0:	6a 6f                	push   $0x6f
  jmp alltraps
801060a2:	e9 42 f7 ff ff       	jmp    801057e9 <alltraps>
...
801060a9:	6a 70                	push   $0x70
  jmp alltraps
801060ab:	e9 39 f7 ff ff       	jmp    801057e9 <alltraps>
...
801060b2:	6a 71                	push   $0x71
  jmp alltraps
801060b4:	e9 30 f7 ff ff       	jmp    801057e9 <alltraps>
...
801060bb:	6a 72                	push   $0x72
  jmp alltraps
801060bd:	e9 27 f7 ff ff       	jmp    801057e9 <alltraps>
...
801060c4:	6a 73                	push   $0x73
  jmp alltraps
801060c6:	e9 1e f7 ff ff       	jmp    801057e9 <alltraps>
...
801060cd:	6a 74                	push   $0x74
  jmp alltraps
801060cf:	e9 15 f7 ff ff       	jmp    801057e9 <alltraps>
...
801060d6:	6a 75                	push   $0x75
  jmp alltraps
801060d8:	e9 0c f7 ff ff       	jmp    801057e9 <alltraps>
...
801060df:	6a 76                	push   $0x76
  jmp alltraps
801060e1:	e9 03 f7 ff ff       	jmp    801057e9 <alltraps>
...
801060e8:	6a 77                	push   $0x77
  jmp alltraps
801060ea:	e9 fa f6 ff ff       	jmp    801057e9 <alltraps>
...
801060f1:	6a 78                	push   $0x78
  jmp alltraps
801060f3:	e9 f1 f6 ff ff       	jmp    801057e9 <alltraps>
...
801060fa:	6a 79                	push   $0x79
  jmp alltraps
801060fc:	e9 e8 f6 ff ff       	jmp    801057e9 <alltraps>
...
80106103:	6a 7a                	push   $0x7a
  jmp alltraps
80106105:	e9 df f6 ff ff       	jmp    801057e9 <alltraps>
...
8010610c:	6a 7b                	push   $0x7b
  jmp alltraps
8010610e:	e9 d6 f6 ff ff       	jmp    801057e9 <alltraps>
...
80106115:	6a 7c                	push   $0x7c
  jmp alltraps
80106117:	e9 cd f6 ff ff       	jmp    801057e9 <alltraps>
...
8010611e:	6a 7d                	push   $0x7d
  jmp alltraps
80106120:	e9 c4 f6 ff ff       	jmp    801057e9 <alltraps>
...
80106127:	6a 7e                	push   $0x7e
  jmp alltraps
80106129:	e9 bb f6 ff ff       	jmp    801057e9 <alltraps>
...
80106130:	6a 7f                	push   $0x7f
  jmp alltraps
80106132:	e9 b2 f6 ff ff       	jmp    801057e9 <alltraps>
...
80106139:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010613e:	e9 a6 f6 ff ff       	jmp    801057e9 <alltraps>
...
80106145:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010614a:	e9 9a f6 ff ff       	jmp    801057e9 <alltraps>
...
80106151:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106156:	e9 8e f6 ff ff       	jmp    801057e9 <alltraps>
...
8010615d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106162:	e9 82 f6 ff ff       	jmp    801057e9 <alltraps>
...
80106169:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010616e:	e9 76 f6 ff ff       	jmp    801057e9 <alltraps>
...
80106175:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010617a:	e9 6a f6 ff ff       	jmp    801057e9 <alltraps>
...
80106181:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106186:	e9 5e f6 ff ff       	jmp    801057e9 <alltraps>
...
8010618d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106192:	e9 52 f6 ff ff       	jmp    801057e9 <alltraps>
...
80106199:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010619e:	e9 46 f6 ff ff       	jmp    801057e9 <alltraps>
...
801061a5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801061aa:	e9 3a f6 ff ff       	jmp    801057e9 <alltraps>
...
801061b1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801061b6:	e9 2e f6 ff ff       	jmp    801057e9 <alltraps>
...
801061bd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801061c2:	e9 22 f6 ff ff       	jmp    801057e9 <alltraps>
...
801061c9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801061ce:	e9 16 f6 ff ff       	jmp    801057e9 <alltraps>
...
801061d5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801061da:	e9 0a f6 ff ff       	jmp    801057e9 <alltraps>
...
801061e1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801061e6:	e9 fe f5 ff ff       	jmp    801057e9 <alltraps>
...
801061ed:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801061f2:	e9 f2 f5 ff ff       	jmp    801057e9 <alltraps>
...
801061f9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801061fe:	e9 e6 f5 ff ff       	jmp    801057e9 <alltraps>
...
80106205:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010620a:	e9 da f5 ff ff       	jmp    801057e9 <alltraps>
...
80106211:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106216:	e9 ce f5 ff ff       	jmp    801057e9 <alltraps>
...
8010621d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106222:	e9 c2 f5 ff ff       	jmp    801057e9 <alltraps>
...
80106229:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010622e:	e9 b6 f5 ff ff       	jmp    801057e9 <alltraps>
...
80106235:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010623a:	e9 aa f5 ff ff       	jmp    801057e9 <alltraps>
...
80106241:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106246:	e9 9e f5 ff ff       	jmp    801057e9 <alltraps>
...
8010624d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106252:	e9 92 f5 ff ff       	jmp    801057e9 <alltraps>
...
80106259:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010625e:	e9 86 f5 ff ff       	jmp    801057e9 <alltraps>
...
80106265:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010626a:	e9 7a f5 ff ff       	jmp    801057e9 <alltraps>
...
80106271:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106276:	e9 6e f5 ff ff       	jmp    801057e9 <alltraps>
...
8010627d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106282:	e9 62 f5 ff ff       	jmp    801057e9 <alltraps>
...
80106289:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010628e:	e9 56 f5 ff ff       	jmp    801057e9 <alltraps>
...
80106295:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010629a:	e9 4a f5 ff ff       	jmp    801057e9 <alltraps>
...
801062a1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801062a6:	e9 3e f5 ff ff       	jmp    801057e9 <alltraps>
...
801062ad:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801062b2:	e9 32 f5 ff ff       	jmp    801057e9 <alltraps>
...
801062b9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801062be:	e9 26 f5 ff ff       	jmp    801057e9 <alltraps>
...
801062c5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801062ca:	e9 1a f5 ff ff       	jmp    801057e9 <alltraps>
...
801062d1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801062d6:	e9 0e f5 ff ff       	jmp    801057e9 <alltraps>
...
801062dd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801062e2:	e9 02 f5 ff ff       	jmp    801057e9 <alltraps>
...
801062e9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801062ee:	e9 f6 f4 ff ff       	jmp    801057e9 <alltraps>
...
801062f5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801062fa:	e9 ea f4 ff ff       	jmp    801057e9 <alltraps>
...
80106301:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106306:	e9 de f4 ff ff       	jmp    801057e9 <alltraps>
...
8010630d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106312:	e9 d2 f4 ff ff       	jmp    801057e9 <alltraps>
...
80106319:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010631e:	e9 c6 f4 ff ff       	jmp    801057e9 <alltraps>
...
80106325:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010632a:	e9 ba f4 ff ff       	jmp    801057e9 <alltraps>
...
80106331:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106336:	e9 ae f4 ff ff       	jmp    801057e9 <alltraps>
...
8010633d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106342:	e9 a2 f4 ff ff       	jmp    801057e9 <alltraps>
...
80106349:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010634e:	e9 96 f4 ff ff       	jmp    801057e9 <alltraps>
...
80106355:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010635a:	e9 8a f4 ff ff       	jmp    801057e9 <alltraps>
...
80106361:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106366:	e9 7e f4 ff ff       	jmp    801057e9 <alltraps>
...
8010636d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106372:	e9 72 f4 ff ff       	jmp    801057e9 <alltraps>
...
80106379:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010637e:	e9 66 f4 ff ff       	jmp    801057e9 <alltraps>
...
80106385:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010638a:	e9 5a f4 ff ff       	jmp    801057e9 <alltraps>
...
80106391:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106396:	e9 4e f4 ff ff       	jmp    801057e9 <alltraps>
...
8010639d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801063a2:	e9 42 f4 ff ff       	jmp    801057e9 <alltraps>
...
801063a9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801063ae:	e9 36 f4 ff ff       	jmp    801057e9 <alltraps>
...
801063b5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801063ba:	e9 2a f4 ff ff       	jmp    801057e9 <alltraps>
...
801063c1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801063c6:	e9 1e f4 ff ff       	jmp    801057e9 <alltraps>
...
801063cd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801063d2:	e9 12 f4 ff ff       	jmp    801057e9 <alltraps>
...
801063d9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801063de:	e9 06 f4 ff ff       	jmp    801057e9 <alltraps>
...
801063e5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801063ea:	e9 fa f3 ff ff       	jmp    801057e9 <alltraps>
...
801063f1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801063f6:	e9 ee f3 ff ff       	jmp    801057e9 <alltraps>
...
801063fd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106402:	e9 e2 f3 ff ff       	jmp    801057e9 <alltraps>
...
80106409:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010640e:	e9 d6 f3 ff ff       	jmp    801057e9 <alltraps>
...
80106415:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010641a:	e9 ca f3 ff ff       	jmp    801057e9 <alltraps>
...
80106421:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106426:	e9 be f3 ff ff       	jmp    801057e9 <alltraps>
...
8010642d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106432:	e9 b2 f3 ff ff       	jmp    801057e9 <alltraps>
...
80106439:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010643e:	e9 a6 f3 ff ff       	jmp    801057e9 <alltraps>
...
80106445:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010644a:	e9 9a f3 ff ff       	jmp    801057e9 <alltraps>
...
80106451:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106456:	e9 8e f3 ff ff       	jmp    801057e9 <alltraps>
...
8010645d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106462:	e9 82 f3 ff ff       	jmp    801057e9 <alltraps>
...
80106469:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010646e:	e9 76 f3 ff ff       	jmp    801057e9 <alltraps>
...
80106475:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010647a:	e9 6a f3 ff ff       	jmp    801057e9 <alltraps>
...
80106481:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106486:	e9 5e f3 ff ff       	jmp    801057e9 <alltraps>
...
8010648d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106492:	e9 52 f3 ff ff       	jmp    801057e9 <alltraps>
...
80106499:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010649e:	e9 46 f3 ff ff       	jmp    801057e9 <alltraps>
...
801064a5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801064aa:	e9 3a f3 ff ff       	jmp    801057e9 <alltraps>
...
801064b1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801064b6:	e9 2e f3 ff ff       	jmp    801057e9 <alltraps>
...
801064bd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801064c2:	e9 22 f3 ff ff       	jmp    801057e9 <alltraps>
...
801064c9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801064ce:	e9 16 f3 ff ff       	jmp    801057e9 <alltraps>
...
801064d5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801064da:	e9 0a f3 ff ff       	jmp    801057e9 <alltraps>
...
801064e1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801064e6:	e9 fe f2 ff ff       	jmp    801057e9 <alltraps>
...
801064ed:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801064f2:	e9 f2 f2 ff ff       	jmp    801057e9 <alltraps>
...
801064f9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801064fe:	e9 e6 f2 ff ff       	jmp    801057e9 <alltraps>
...
80106505:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010650a:	e9 da f2 ff ff       	jmp    801057e9 <alltraps>
...
80106511:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106516:	e9 ce f2 ff ff       	jmp    801057e9 <alltraps>
...
8010651d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106522:	e9 c2 f2 ff ff       	jmp    801057e9 <alltraps>
...
80106529:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010652e:	e9 b6 f2 ff ff       	jmp    801057e9 <alltraps>
...
80106535:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010653a:	e9 aa f2 ff ff       	jmp    801057e9 <alltraps>
...
80106541:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106546:	e9 9e f2 ff ff       	jmp    801057e9 <alltraps>
...
8010654d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106552:	e9 92 f2 ff ff       	jmp    801057e9 <alltraps>
...
80106559:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010655e:	e9 86 f2 ff ff       	jmp    801057e9 <alltraps>
...
80106565:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010656a:	e9 7a f2 ff ff       	jmp    801057e9 <alltraps>
...
80106571:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106576:	e9 6e f2 ff ff       	jmp    801057e9 <alltraps>
...
8010657d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106582:	e9 62 f2 ff ff       	jmp    801057e9 <alltraps>
...
80106589:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010658e:	e9 56 f2 ff ff       	jmp    801057e9 <alltraps>
...
80106595:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010659a:	e9 4a f2 ff ff       	jmp    801057e9 <alltraps>
...
801065a1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801065a6:	e9 3e f2 ff ff       	jmp    801057e9 <alltraps>
...
801065ad:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801065b2:	e9 32 f2 ff ff       	jmp    801057e9 <alltraps>
...
801065b9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801065be:	e9 26 f2 ff ff       	jmp    801057e9 <alltraps>
...
801065c5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801065ca:	e9 1a f2 ff ff       	jmp    801057e9 <alltraps>
...
801065d1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801065d6:	e9 0e f2 ff ff       	jmp    801057e9 <alltraps>
...
801065dd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801065e2:	e9 02 f2 ff ff       	jmp    801057e9 <alltraps>
...
801065e9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801065ee:	e9 f6 f1 ff ff       	jmp    801057e9 <alltraps>
...
801065f5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801065fa:	e9 ea f1 ff ff       	jmp    801057e9 <alltraps>
...
80106601:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106606:	e9 de f1 ff ff       	jmp    801057e9 <alltraps>
...
8010660d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106612:	e9 d2 f1 ff ff       	jmp    801057e9 <alltraps>
...
80106619:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010661e:	e9 c6 f1 ff ff       	jmp    801057e9 <alltraps>
...
80106625:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010662a:	e9 ba f1 ff ff       	jmp    801057e9 <alltraps>
...
80106631:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106636:	e9 ae f1 ff ff       	jmp    801057e9 <alltraps>
...
8010663d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106642:	e9 a2 f1 ff ff       	jmp    801057e9 <alltraps>
...
80106649:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010664e:	e9 96 f1 ff ff       	jmp    801057e9 <alltraps>
...
80106655:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010665a:	e9 8a f1 ff ff       	jmp    801057e9 <alltraps>
...
80106661:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106666:	e9 7e f1 ff ff       	jmp    801057e9 <alltraps>
...
8010666d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106672:	e9 72 f1 ff ff       	jmp    801057e9 <alltraps>
...
80106679:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010667e:	e9 66 f1 ff ff       	jmp    801057e9 <alltraps>
...
80106685:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010668a:	e9 5a f1 ff ff       	jmp    801057e9 <alltraps>
...
80106691:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106696:	e9 4e f1 ff ff       	jmp    801057e9 <alltraps>
...
8010669d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801066a2:	e9 42 f1 ff ff       	jmp    801057e9 <alltraps>
...
801066a9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801066ae:	e9 36 f1 ff ff       	jmp    801057e9 <alltraps>
...
801066b5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801066ba:	e9 2a f1 ff ff       	jmp    801057e9 <alltraps>
...
801066c1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801066c6:	e9 1e f1 ff ff       	jmp    801057e9 <alltraps>
...
801066cd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801066d2:	e9 12 f1 ff ff       	jmp    801057e9 <alltraps>
...
801066d9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801066de:	e9 06 f1 ff ff       	jmp    801057e9 <alltraps>
...
801066e5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801066ea:	e9 fa f0 ff ff       	jmp    801057e9 <alltraps>
...
801066f1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801066f6:	e9 ee f0 ff ff       	jmp    801057e9 <alltraps>
...
801066fd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106702:	e9 e2 f0 ff ff       	jmp    801057e9 <alltraps>
...
80106709:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010670e:	e9 d6 f0 ff ff       	jmp    801057e9 <alltraps>
...
80106715:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010671a:	e9 ca f0 ff ff       	jmp    801057e9 <alltraps>
...
80106721:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106726:	e9 be f0 ff ff       	jmp    801057e9 <alltraps>
...
8010672d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106732:	e9 b2 f0 ff ff       	jmp    801057e9 <alltraps>
...
8010679a:	e8 51 de ff ff       	call   801045f0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010683d:	68 b0 79 10 80       	push   $0x801079b0
...
80106980:	a1 e4 55 11 80       	mov    0x801155e4,%eax
{
...
801069c4:	0f 84 c2 00 00 00    	je     80106a8c <switchuvm+0xec>
  pushcli();
801069ca:	e8 01 d9 ff ff       	call   801042d0 <pushcli>
...
80106adf:	e8 0c db ff ff       	call   801045f0 <memset>
...
80106b10:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b11:	e9 8a db ff ff       	jmp    801046a0 <memmove>
    panic("inituvm: more than a page");
80106b16:	83 ec 0c             	sub    $0xc,%esp
80106b19:	68 f5 79 10 80       	push   $0x801079f5
...
80106c3b:	e8 b0 d9 ff ff       	call   801045f0 <memset>
...
80106c7d:	68 2d 7a 10 80       	push   $0x80107a2d
...
80106cb3:	68 45 7a 10 80       	push   $0x80107a45
...
80106dbc:	68 61 7a 10 80       	push   $0x80107a61
...
80106df0:	e8 fb d7 ff ff       	call   801045f0 <memset>
...
80106e5b:	a3 e4 55 11 80       	mov    %eax,0x801155e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e8f:	68 72 7a 10 80       	push   $0x80107a72
...
80106ee0:	e8 bb d7 ff ff       	call   801046a0 <memmove>
...
80106f79:	68 96 7a 10 80       	push   $0x80107a96
80106f7e:	e8 0d 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106f83:	83 ec 0c             	sub    $0xc,%esp
80106f86:	68 7c 7a 10 80       	push   $0x80107a7c
...
8010700f:	e8 8c d6 ff ff       	call   801046a0 <memmove>
    len -= n;
    buf += n;
