...
_ticketlocktest:     file format elf32-i386
...
int main()
{
   ...
   f:	bb 0a 00 00 00       	mov    $0xa,%ebx
	ticketlockInit();
  14:	e8 79 03 00 00       	call   392 <ticketlockInit>
	pid = fork();
  19:	e8 cc 02 00 00       	call   2ea <fork>
  1e:	66 90                	xchg   %ax,%ax

	for (int i = 0; i < NCHILD; i++)
		if (pid > 0)
  20:	85 c0                	test   %eax,%eax
  22:	7e 05                	jle    29 <main+0x29>
			pid = fork();
  24:	e8 c1 02 00 00       	call   2ea <fork>
	for (int i = 0; i < NCHILD; i++)
  29:	83 eb 01             	sub    $0x1,%ebx
  2c:	75 f2                	jne    20 <main+0x20>

	if (pid < 0)
  2e:	85 c0                	test   %eax,%eax
  30:	78 56                	js     88 <main+0x88>
	{
		printf(2, "fork error\n");
	}

	else if (pid == 0)
  32:	74 3c                	je     70 <main+0x70>
		ticketlockTest();
	}
  ...
  41:	e8 3c 03 00 00       	call   382 <sleep>
  46:	83 c4 10             	add    $0x10,%esp
  49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		for (int i = 0; i < NCHILD; i++)
			wait();
  50:	e8 a5 02 00 00       	call   2fa <wait>
		for (int i = 0; i < NCHILD; i++)
  ...
  5a:	50                   	push   %eax
  5b:	50                   	push   %eax
  5c:	68 c4 07 00 00       	push   $0x7c4
  61:	6a 01                	push   $0x1
  63:	e8 f8 03 00 00       	call   460 <printf>
  68:	83 c4 10             	add    $0x10,%esp
	}

	exit();
  6b:	e8 82 02 00 00       	call   2f2 <exit>
		printf(1, "child adding to shared counter\n");
  70:	52                   	push   %edx
  71:	52                   	push   %edx
  72:	68 dc 07 00 00       	push   $0x7dc
  77:	6a 01                	push   $0x1
  79:	e8 e2 03 00 00       	call   460 <printf>
		ticketlockTest();
  7e:	e8 17 03 00 00       	call   39a <ticketlockTest>
  83:	83 c4 10             	add    $0x10,%esp
  86:	eb e3                	jmp    6b <main+0x6b>
		printf(2, "fork error\n");
  88:	51                   	push   %ecx
  89:	51                   	push   %ecx
  8a:	68 b8 07 00 00       	push   $0x7b8
  8f:	6a 02                	push   $0x2
  91:	e8 ca 03 00 00       	call   460 <printf>
  96:	83 c4 10             	add    $0x10,%esp
  99:	eb d0                	jmp    6b <main+0x6b>
  9b:	66 90                	xchg   %ax,%ax
  9d:	66 90                	xchg   %ax,%ax
  9f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb fc 07 00 00       	mov    $0x7fc,%ebx
        while(*s != 0){
 ...
 631:	a1 ac 0a 00 00       	mov    0xaac,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 ac 0a 00 00       	mov    %eax,0xaac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 787:	0a 00 00 
 78a:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 b0 0a 00 00       	mov    $0xab0,%eax
 799:	c7 05 b4 0a 00 00 00 	movl   $0x0,0xab4
 7a0:	00 00 00 
